...
!function($, window, document, _undefined)
{
    ...
    KomuKuYJB.ReplyLoader = function($element) { this.__construct($element); };
    KomuKuYJB.ReplyLoader.prototype =
    {
    ...
    KomuKuYJB.ReplyPosterClickId = null;

    KomuKuYJB.ReplyPoster = function($element) { this.__construct($element); };
    KomuKuYJB.ReplyPoster.prototype =
    {
        __construct: function($link)
        {
            this.$link = $link;
        ...
        click: function(e)
        {
            ...
            this.$commentArea.xfFadeDown(XenForo.speed.fast, function()
            {
                ...
                KomuKuYJB.ReplyPosterClickId = self.$commentId;
            });
        },
        ...
        submit: function(e)
        {
            ...
            if (this.$commentId != KomuKuYJB.ReplyPosterClickId)
            {
                return;
            }
    ...
    XenForo.register('a.ReplyLoader', 'KomuKuYJB.ReplyLoader');
    XenForo.register('a.ReplyPoster', 'KomuKuYJB.ReplyPoster');
}
