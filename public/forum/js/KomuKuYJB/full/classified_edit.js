...
!function ($, window, document, _undefined)
{
    ...
    KomuKuYJB.PackageInfoLoader = function($select)
    {
    ...
    KomuKuYJB.PriceValidation = function($input)
    {
    ...
    XenForo.register('.PackageLoader', 'KomuKuYJB.PackageInfoLoader');
    XenForo.register('.PriceValidation', 'KomuKuYJB.PriceValidation');
}
