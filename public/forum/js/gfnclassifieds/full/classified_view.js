...
!function ($, window, document, _undefined)
{
    ...
    GFNClassifieds.Gallery = function($container) { this.Gallery($container) };
    GFNClassifieds.Gallery.prototype =
    {
    ...
    GFNClassifieds.LocationMap = function($container)
    {
        var mapOptions =
        {
            zoom: 16,
    ...
    GFNClassifieds.SocialShare = function($container)
    {
    ...
    GFNClassifieds.CommentButton = function ($button)
    {
    ...
    XenForo.register('.GalleryThumbContainer', 'GFNClassifieds.Gallery');
    XenForo.register('.MiniGalleryContainer', 'GFNClassifieds.Gallery');
    XenForo.register('.SocialShareLinks', 'GFNClassifieds.SocialShare');
    XenForo.register('.CommentButton', 'GFNClassifieds.CommentButton');

    if (typeof google == 'object' && typeof google.maps == 'object')
    {
        XenForo.register('.LocationMap', 'GFNClassifieds.LocationMap');
    }
}
