...
// _kmk_JS_UNCOMPRESSED_TEST_ - do not edit/remove
...
!function($, window, document, _undefined)
{
	...
	$.extend(XenForo,
	{
		 ...
		 * @var object
		 */
		_cookieConfig: { path: '/', domain: '', 'prefix': 'kmk_'},
	...
	XenForo.AutoComplete.getDefaultUrl = function()
	{
		if (XenForo.AutoComplete.defaultUrl === null)
		{
			...
			{
				XenForo.AutoComplete.defaultUrl = 'whatyouseewhatyouget.php?users/search-name&_xfResponseType=json';
			}
			else
			{
