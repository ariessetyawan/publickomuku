...
KomuKu.AutoCompleteGeneric= function($element) { this.__construct($element); };
KomuKu.AutoCompleteGeneric.prototype =
{
...
XenForo.register('input, textarea', function(i)
{
	...
	{
		XenForo.create('KomuKu.AutoCompleteGeneric', this);
	}
});
