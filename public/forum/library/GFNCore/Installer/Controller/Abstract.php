...
abstract class GFNCore_Installer_Controller_Abstract
{
    ...
    protected $_minPHPVersion = 50307;
    ...
    {
        $this->_minPHPVersion = intval($version);
    }
    ...
    {
        $this->callHook('php_version_pre_check');

        if (PHP_VERSION_ID < $this->_minPHPVersion)
        {
            throw $this->exception('minimum_php_version_error');
        }

        $this->callHook('php_version_post_check');
    }
