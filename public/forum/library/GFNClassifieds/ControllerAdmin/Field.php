 ...
 */
class GFNClassifieds_ControllerAdmin_Field extends GFNClassifieds_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Field_List', 'classifieds_field_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $field, array $viewParams = array())
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Field_Edit', 'classifieds_field_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var GFNClassifieds_DataWriter_Field $writer */
        $writer = XenForo_DataWriter::create('GFNClassifieds_DataWriter_Field');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Field_Delete', 'classifieds_field_delete', $viewParams);
    }
