 ...
 */
class GFNClassifieds_ControllerAdmin_PrefixGroup extends GFNClassifieds_ControllerAdmin_Abstract
{
    ...
    protected function _getAddEditResponse(array $group, array $viewParams = array())
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_PrefixGroup_Edit', 'classifieds_prefix_group_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var GFNClassifieds_DataWriter_PrefixGroup $writer */
        $writer = XenForo_DataWriter::create('GFNClassifieds_DataWriter_PrefixGroup');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_PrefixGroup_Delete', 'classifieds_prefix_group_delete', $viewParams);
    }
