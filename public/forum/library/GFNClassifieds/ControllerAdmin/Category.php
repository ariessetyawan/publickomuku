 ...
 */
class GFNClassifieds_ControllerAdmin_Category extends GFNClassifieds_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Category_List', 'classifieds_category_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $category, array $viewParams = array())
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Category_Edit', 'classifieds_category_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var GFNClassifieds_DataWriter_Category $writer */
        $writer = XenForo_DataWriter::create('GFNClassifieds_DataWriter_Category');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewAdmin_Category_Delete', 'classifieds_category_delete', $viewParams);
    }
