 ...
 */
class GFNClassifieds_ContentPermission_Category implements XenForo_ContentPermission_Interface
{
    ...
    {
        return XenForo_Model::create('GFNClassifieds_Model_Category');
    }
}