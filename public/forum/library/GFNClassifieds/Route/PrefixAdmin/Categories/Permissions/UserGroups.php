 ...
 */
class GFNClassifieds_Route_PrefixAdmin_Categories_Permissions_UserGroups implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        $action = $router->resolveActionWithIntegerParam($routePath, $request, 'user_group_id');
        return $router->getRouteMatch('GFNClassifieds_ControllerAdmin_CategoryPermission_UserGroup', $action);
    }
