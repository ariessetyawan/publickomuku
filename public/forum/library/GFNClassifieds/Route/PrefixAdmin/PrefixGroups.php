 ...
 */
class GFNClassifieds_Route_PrefixAdmin_PrefixGroups implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        $action = $router->resolveActionWithIntegerParam($routePath, $request, 'prefix_group_id');
        return $router->getRouteMatch('GFNClassifieds_ControllerAdmin_PrefixGroup', $action, 'classifiedPrefixes');
    }
