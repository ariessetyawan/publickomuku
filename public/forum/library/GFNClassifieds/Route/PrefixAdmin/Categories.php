 ...
 */
class GFNClassifieds_Route_PrefixAdmin_Categories extends GFNCore_Route_PrefixBackbone
{
    ...
    {
        return array(
            'default' => 'controller:GFNClassifieds_ControllerAdmin_Category',
            'permissions' => array(
                'default' => 'controller:GFNClassifieds_ControllerAdmin_CategoryPermission_Home',
                'users' => 'GFNClassifieds_Route_PrefixAdmin_Categories_Permissions_Users',
                'user-groups' => 'GFNClassifieds_Route_PrefixAdmin_Categories_Permissions_UserGroups'
            )
        );
    }
} 