 ...
 */
class GFNClassifieds_Route_Prefix_Traders extends GFNCore_Route_PrefixBackbone
{
    protected function _getRouteClasses()
    {
        return array(
            'default' => function($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
            {
                ...
                return $router->getRouteMatch('GFNClassifieds_ControllerPublic_Trader', $action);
            },
            'ratings' => 'GFNClassifieds_Route_Prefix_Traders_Ratings',
            'rate' => 'GFNClassifieds_Route_Prefix_Traders_Rate'
        );
    }
