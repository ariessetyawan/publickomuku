 ...
 */
class GFNClassifieds_Route_Prefix_Categories implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        $action = $router->resolveActionWithIntegerParam($routePath, $request, 'category_id', 'view');
        return $router->getRouteMatch('GFNClassifieds_ControllerPublic_Category', $action);
    }
