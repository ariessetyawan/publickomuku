 ...
 */
class GFNClassifieds_Route_Prefix_Classifieds extends GFNCore_Route_PrefixBackbone
{
    protected function _getRouteClasses()
    {
        return array(
            ...
            {
                return $router->getRouteMatch('GFNClassifieds_ControllerPublic_Classified', $routePath);
            },
            'fields' => 'GFNClassifieds_Route_Prefix_Classifieds_Fields',
            'contact' => 'GFNClassifieds_Route_Prefix_Classifieds_Contact',
            'comments' => 'GFNClassifieds_Route_Prefix_Classifieds_Comments'
        );
    }
