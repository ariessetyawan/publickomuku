 ...
 */
class GFNClassifieds_ControllerPublic_Home extends GFNClassifieds_ControllerPublic_Abstract
{
    public function actionIndex()
    {
        if ($this->_input->filterSingle('classified_id', XenForo_Input::UINT))
        {
            return $this->responseReroute('GFNClassifieds_ControllerPublic_Classified', 'view');
        }
        ...
        $extraSidebarBlocks = array(
            'bottom' => array(
                $this->responseView('GFNClassifieds_SidebarBlock_ClassifiedStats', 'classifieds_sidebar_block_stats')
            )
        );
        ...
        return $this->_getWrapper(
            $this->responseView(
                'GFNClassifieds_ViewPublic_Home', 'classifieds_home', $viewParams
            ), $containerParams
        );
    }
    ...
    public function actionCreate()
    {
        ...
        {
            return $this->responseReroute('GFNClassifieds_ControllerPublic_Category', 'create-item');
        }
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_ChooseCategory', 'classifieds_choose_category', $viewParams);
    }
    ...
    public function actionPackageInfo()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_PackageInfo', 'classifieds_package_info', $viewParams);
    }
    ...
    public function actionFetchLocation()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_FetchLocation', 'classifieds_location_fetch', $viewParams);
    }
    ...
    public function actionFilterMenu()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_FilterMenu', 'classifieds_filter_menu', $viewParams);
    }
