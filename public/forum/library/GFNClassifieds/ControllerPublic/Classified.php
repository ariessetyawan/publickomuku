 ...
 */
class GFNClassifieds_ControllerPublic_Classified extends GFNClassifieds_ControllerPublic_Abstract
{
    ...
    public function actionView()
    {
        ...
        return $this->_getWrapper(
            'description', $this->responseView(
                'GFNClassifieds_ViewPublic_Classified_Description',
    ...
    public function actionField()
    {
        ...
        return $this->_getWrapper(
            $selectedTab, $this->responseView(
                'GFNClassifieds_ViewPublic_Classified_Field',
    ...
    public function actionWatch()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Watch', 'classifieds_item_watch', $viewParams);
        }
    }
    ...
    public function actionLocation()
    {
        ...
        return $this->_getWrapper(
            'location', $this->responseView(
                'GFNClassifieds_ViewPublic_Classified_Location',
    ...
    public function actionTags()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Tags', 'classifieds_item_tags', $viewParams);
        }
    }
    ...
    public function actionGallery()
    {
        ...
        return $this->_getWrapper(
            'gallery', $this->responseView(
                'GFNClassifieds_ViewPublic_Classified_Gallery',
    ...
    public function actionComment()
    {
        ...
        $perPage = GFNClassifieds_Options::getInstance()->get('commentsPerPage');
        ...
        return $this->_getWrapper(
                ...
                'GFNClassifieds_ViewPublic_Classified_Comment',
    ...
    public function actionIp()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Ip', 'classifieds_item_ip', $viewParams);
    }
    ...
    public function actionContact()
    {
        ...
        if ($classified['conversation_id'])
        {
            ...
            XenForo_Application::set('GFNClassifiedsContactPage', array($classified, $category));
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Contact', 'classifieds_item_contact', $viewParams);
    }
    ...
    public function actionAdd()
    {
        ...
        {
            return $this->responseReroute('GFNClassifieds_ControllerPublic_Home', 'create');
        }
        ...
        $classified = array(
            ...
            'classified_id' => null,
            'location_private' => GFNClassifieds_Options::getInstance()->get('privateLocationByDefault'),
            'package_id' => GFNClassifieds_Options::getInstance()->get('defaultPackageId')
        );
    ...
    protected function _getAddEditResponse(array $classified, array $category, array $attachments, array $viewParams = array())
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Edit', 'classifieds_item_edit', $viewParams);
    }
    ...
    public function actionActivate()
    {
        ...
        if ($this->models()->classified()->hasPermission('activateAny', $category))
        {
            ...
            $payment = new GFNClassifieds_Eloquent_Payment($payment);
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Pay', 'classifieds_item_pay', $viewParams);
    }
    ...
    public function actionPreview()
    {
        ...
        {
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Preview', '', array('classified' => false));
        }
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Preview', 'classifieds_list_item_preview', $viewParams);
    }
    ...
    public function actionEditPreview()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Preview', 'classifieds_item_edit_preview', $viewParams);
    }
    ...
    public function actionLike()
    {
        ...
        if ($this->_request->isPost())
        {
            ...
            if ($this->_noRedirect() && $latestUsers !== false)
            {
                ...
                return $this->responseView(
                    'GFNClassifieds_ViewPublic_Classified_LikeConfirmed', '', $viewParams
                );
            }
            else
            {
        ...
        else
        {
            ...
            return $this->responseView(
                'GFNClassifieds_ViewPublic_Classified_Like', 'classifieds_item_like', $viewParams
            );
        }
    }
    ...
    public function actionLikes()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_Classified_Likes', 'classifieds_item_likes', $viewParams);
    }
    ...
    public function actionReport()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Report', 'classifieds_item_report', $viewParams);
        }
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Delete', 'classifieds_item_delete', $viewParams);
        }
    }
    ...
    public function actionUndelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Undelete', 'classifieds_item_undelete', $viewParams);
        }
    }
    ...
    public function actionMarkComplete()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_MarkComplete', 'classifieds_item_mark_complete', $viewParams);
        }
    }
    ...
    public function actionBump()
    {
        ...
        $this->models()->classified()->bumpClassified($classified);
    ...
    public function actionClose()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Close', 'classifieds_item_close', $viewParams);
        }
    }
    ...
    public function actionRenew()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Renew', 'classifieds_item_renew', $viewParams);
        }
    }
    ...
    public function actionReassign()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_Classified_Reassign', 'classifieds_item_reassign', $viewParams);
        }
    }
    ...
    {
        return $this->getHelper('GFNClassifieds_ControllerHelper_PageWrapper')->getClassifiedViewWrapper($selectedTab, $subView, $classified, $category, $containerParams);
    }
    ...
    protected function _getClassifiedViewInfo(array $fetchOptions = array())
    {
        ...
        $fetchOptions['join'] |= GFNClassifieds_Model_Classified::FETCH_CATEGORY | GFNClassifieds_Model_Classified::FETCH_LOCATION;

        if (XenForo_Visitor::getInstance()->hasPermission('classifieds', 'viewDeleted'))
        {
            $fetchOptions['join'] |= GFNClassifieds_Model_Classified::FETCH_DELETION_LOG;
        }
    ...
    public static function getSessionActivityDetailsForList(array $activities)
    {
        ...
        if ($classifiedIds)
        {
            /** @var GFNClassifieds_Model_Classified $classifiedModel */ /** @var GFNClassifieds_Model_Category $categoryModel */
