 ...
 */
abstract class GFNClassifieds_ControllerPublic_Abstract extends XenForo_ControllerPublic_Abstract
{
    ...
    protected function _assertCorrectVersion($action)
    {
        ...
        if (GFNClassifieds_Application::$versionId != GFNCore_Application::getInstalledVersion('GFNClassifieds'))
        {
    ...
    /**
     * @return GFNClassifieds_ControllerHelper_Content
     */
    public function getContentHelper()
    {
        return $this->getHelper('GFNClassifieds_ControllerHelper_Content');
    }
