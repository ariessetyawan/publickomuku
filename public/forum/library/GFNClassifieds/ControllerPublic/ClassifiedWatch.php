 ...
 */
class GFNClassifieds_ControllerPublic_ClassifiedWatch extends GFNClassifieds_ControllerPublic_Abstract
{
    ...
    public function actionIndex()
    {
        ...
        return $this->responseView('GFNClassifieds_ViewPublic_WatchedClassifieds', 'classifieds_watched', $viewParams);
    }
    ...
    public function actionUpdate()
    {
        ...
        {
            $writer = XenForo_DataWriter::create('GFNClassifieds_DataWriter_ClassifiedWatch');
