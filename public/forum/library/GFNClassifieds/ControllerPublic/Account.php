 ...
 */
class GFNClassifieds_ControllerPublic_Account extends GFNClassifieds_ControllerPublic_Abstract
{
    ...
    public function actionClassifieds()
    {
        ...
        return $this->_getWrapper('classified', 'list', $this->responseView(
            'GFNClassifieds_ViewPublic_Account_Classified', 'classifieds_account_classified', $viewParams
        ));
    }
