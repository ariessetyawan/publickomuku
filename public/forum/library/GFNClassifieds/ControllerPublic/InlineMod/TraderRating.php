 ...
 */
class GFNClassifieds_ControllerPublic_InlineMod_TraderRating extends GFNClassifieds_ControllerPublic_InlineMod_Abstract
{
    public $inlineModKey = 'trader_ratings';

    /**
     * @return GFNClassifieds_Model_InlineMod_TraderRating
     */
    public function getInlineModTypeModel()
    {
        return $this->getModelFromCache('GFNClassifieds_Model_InlineMod_TraderRating');
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_TraderRatingInlineMod_Delete', 'inline_mod_classified_trader_rating_delete', $viewParams);
        }
    }
