 ...
 */
class GFNClassifieds_ControllerPublic_InlineMod_Classified extends GFNClassifieds_ControllerPublic_InlineMod_Abstract
{
    public $inlineModKey = 'classifieds';

    /**
     * @return GFNClassifieds_Model_InlineMod_Classified
     */
    public function getInlineModTypeModel()
    {
        return $this->getModelFromCache('GFNClassifieds_Model_InlineMod_Classified');
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_ClassifiedInlineMod_Delete', 'inline_mod_classified_delete', $viewParams);
        }
    }
    ...
    public function actionReassign()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_ClassifiedInlineMod_Reassign', 'inline_mod_classified_reassign', $viewParams);
        }
    }
    ...
    public function actionMove()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_ClassifiedInlineMod_Move', 'inline_mod_classified_move', $viewParams);
        }
    }
    ...
    public function actionPrefix()
    {
        ...
        else
        {
            ...
            return $this->responseView('GFNClassifieds_ViewPublic_ClassifiedInlineMod_Prefix', 'inline_mod_classified_prefix', $viewParams);
        }
    }
