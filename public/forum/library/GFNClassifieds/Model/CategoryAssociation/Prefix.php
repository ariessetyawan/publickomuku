 ...
 */
class GFNClassifieds_Model_CategoryAssociation_Prefix extends XenForo_Model
{
    ...
    public function rebuildAssociationCache($categoryIds = null)
    {
        ...
        /** @var GFNClassifieds_Model_Prefix $model */
        $model = $this->getModelFromCache('GFNClassifieds_Model_Prefix');
