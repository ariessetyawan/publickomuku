 ...
 */
class GFNClassifieds_Model_CategoryAssociation_RatingCriteria extends XenForo_Model
{
    ...
    public function rebuildAssociationCache($categoryIds = null)
    {
        ...
        /** @var GFNClassifieds_Model_TraderRatingCriteria $model */
        $model = $this->getModelFromCache('GFNClassifieds_Model_TraderRatingCriteria');
