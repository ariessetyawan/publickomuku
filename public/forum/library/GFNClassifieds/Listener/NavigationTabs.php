 ...
 */
class GFNClassifieds_Listener_NavigationTabs
{
    public static function classifieds(array &$extraTabs)
    {
        ...
        $extraTabs += array(
            'classifieds' => array(
                ...
                'position' => GFNClassifieds_Options::getInstance()->get('navTabLocation'),
                'linksTemplate' => 'classifieds_tab_links',
                'canAddClassified' => XenForo_Model::create('GFNClassifieds_Model_Category')->canAddClassified()
            )
        );
    }
}