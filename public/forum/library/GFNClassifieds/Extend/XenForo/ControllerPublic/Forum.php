 ...
 */
class GFNClassifieds_Extend_XenForo_ControllerPublic_Forum extends XFCP_GFNClassifieds_Extend_XenForo_ControllerPublic_Forum
{
    protected function _postDispatch($controllerResponse, $controllerName, $action)
    {
        parent::_postDispatch($controllerResponse, $controllerName, $action);

        if (!GFNClassifieds_Options::getInstance()->get('showAddButtonInForum'))
        {
            return;
        }
    ...
    public function actionIndex()
    {
        ...
        $newClassifiedLimit = GFNClassifieds_Options::getInstance()->get('forumListNewClassifieds');
        ...
        $randomClassifiedLimit = GFNClassifieds_Options::getInstance()->get('forumListRandomClassifieds');
        ...
        $featuredClassifiedLimit = GFNClassifieds_Options::getInstance()->get('forumListFeaturedClassifieds');
    ...
    public function actionForum()
    {
        ...
        $model = $this->getModelFromCache('GFNClassifieds_Model_Classified');
