 ...
 */
class GFNClassifieds_Extend_XenForo_ControllerPublic_Thread extends XFCP_GFNClassifieds_Extend_XenForo_ControllerPublic_Thread
{
    public function actionIndex()
    {
        ...
        if ($response instanceof XenForo_ControllerResponse_View)
        {
            ...
            {
                /** @var GFNClassifieds_Model_Classified $classifiedModel */ /** @var GFNClassifieds_Model_Category $categoryModel */ /** @var GFNClassifieds_Model_AdvertType $advertTypeModel */ /** @var GFNClassifieds_Model_Comment $commentModel */
                ...
                $advertTypeModel = $this->getModelFromCache('GFNClassifieds_Model_AdvertType');
                $commentModel = $this->getModelFromCache('GFNClassifieds_Model_Comment');
                ...
                if ($classified)
                {
                    ...
                    if ($classifiedModel->canViewClassifiedAndContainer($classified, $classified))
                    {
                        ...
                        $params['socialLinks'] = GFNClassifieds_Helper_Misc::getSocialShareLinks(
