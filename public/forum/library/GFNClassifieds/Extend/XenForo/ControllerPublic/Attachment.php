 ...
 */
class GFNClassifieds_Extend_XenForo_ControllerPublic_Attachment extends XFCP_GFNClassifieds_Extend_XenForo_ControllerPublic_Attachment
{
    public function actionDoUpload()
    {
        XenForo_Application::set(
            'GFNClassifiedsAttachmentContentType',
