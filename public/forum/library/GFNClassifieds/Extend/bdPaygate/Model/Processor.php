 ...
 */
class GFNClassifieds_Extend_bdPaygate_Model_Processor extends XFCP_GFNClassifieds_Extend_bdPaygate_Model_Processor
{
    ...
    {
        return $this->getModelFromCache('GFNClassifieds_Model_Payment');
    }
}