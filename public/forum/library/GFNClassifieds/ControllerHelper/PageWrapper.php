 ...
 */
class GFNClassifieds_ControllerHelper_PageWrapper extends XenForo_ControllerHelper_Abstract
{
    public function getClassifiedListWrapper(XenForo_ControllerResponse_View $subView, array $containerParams = array())
    {
        /** @var GFNClassifieds_Model_Category $categoryModel */ /** @var GFNClassifieds_Model_Classified $classifiedModel */
        $categoryModel = $this->_controller->getModelFromCache('GFNClassifieds_Model_Category');
        $classifiedModel = $this->_controller->getModelFromCache('GFNClassifieds_Model_Classified');
        ...
        $wrapper = $this->_controller->responseView('GFNClassifieds_ViewPublic_ClassifiedList_PageWrapper', 'classifieds_page_wrapper', $containerParams);
        $wrapper->containerParams['bodyClasses'] = 'sidebarTo' . ucfirst(GFNClassifieds_Options::getInstance()->get('sidebarLocation'));
    ...
    public function getClassifiedViewWrapper($selectedTab, XenForo_ControllerResponse_View $subView, array $classified, array $category, array $containerParams = array())
    {
        ...
        if (empty($containerParams['advertType']))
        {
            ...
            $advertTypeModel = $this->_controller->getModelFromCache('GFNClassifieds_Model_AdvertType');
        ...
        $commentModel = $this->_controller->getModelFromCache('GFNClassifieds_Model_Comment');
        ...
        {
            /** @var GFNClassifieds_Model_TraderRating $ratingModel */
            $ratingModel = $this->_controller->getModelFromCache('GFNClassifieds_Model_TraderRating');
        ...
        $otherClassifiedsLimit = GFNClassifieds_Options::getInstance()->get('classifiedViewOtherClassifieds');
        ...
        $containerParams += array(
            ...
            'socialLinks' => GFNClassifieds_Helper_Misc::getSocialShareLinks(
        ...
        $wrapper = $this->_controller->responseView('GFNClassifieds_ViewPublic_Classified_PageWrapper', 'classifieds_item_view', $containerParams);
    ...
    public function getAccountViewWrapper($selectedGroup, $selectedLink, XenForo_ControllerResponse_View $subView)
    {
        ...
        $wrapper = $this->_controller->responseView('GFNClassifieds_ViewPublic_Account_PageWrapper', 'classifieds_account_wrapper', $viewParams);
        $wrapper->subView = $subView;
