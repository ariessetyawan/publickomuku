 ...
 */
class GFNClassifieds_Installer_Data_1000011 extends GFNCore_Installer_Data_Abstract
{
    ...
    protected function _insertContentTypes()
    {
        ...
        // Category...
        $handler->add('classified_category', $handler::PERMISSION_HANDLER, 'GFNClassifieds_ContentPermission_Category');
        $handler->add('classified_category', $handler::MODERATOR_HANDLER, 'GFNClassifieds_ModeratorHandler_Category');
        $handler->add('classified_category', $handler::SITEMAP_HANDLER, 'GFNClassifieds_SitemapHandler_Category');

        // Classified...
        $handler->add('classified', $handler::ALERT_HANDLER, 'GFNClassifieds_AlertHandler_Classified');
        $handler->add('classified', $handler::ATTACHMENT_HANDLER, 'GFNClassifieds_AttachmentHandler_Classified');
        $handler->add('classified', $handler::EDIT_HISTORY_HANDLER, 'GFNClassifieds_EditHistoryHandler_Classified');
        $handler->add('classified', $handler::LIKE_HANDLER, 'GFNClassifieds_LikeHandler_Classified');
        $handler->add('classified', $handler::MODERATION_QUEUE_HANDLER, 'GFNClassifieds_ModerationQueueHandler_Classified');
        $handler->add('classified', $handler::MODERATOR_LOG_HANDLER, 'GFNClassifieds_ModeratorLogHandler_Classified');
        $handler->add('classified', $handler::NEWS_FEED_HANDLER, 'GFNClassifieds_NewsFeedHandler_Classified');
        $handler->add('classified', $handler::REPORT_HANDLER, 'GFNClassifieds_ReportHandler_Classified');
        $handler->add('classified', $handler::SEARCH_HANDLER, 'GFNClassifieds_Search_DataHandler_Classified');
        $handler->add('classified', $handler::SITEMAP_HANDLER, 'GFNClassifieds_SitemapHandler_Classified');
        $handler->add('classified', $handler::SPAM_HANDLER, 'GFNClassifieds_SpamHandler_Classified');
        $handler->add('classified', $handler::STATS_HANDLER, 'GFNClassifieds_StatsHandler_Classified');
        $handler->add('classified', $handler::WARNING_HANDLER, 'GFNClassifieds_WarningHandler_Classified');

        // Classified Gallery...
        $handler->add('classified_gallery', $handler::ATTACHMENT_HANDLER, 'GFNClassifieds_AttachmentHandler_ClassifiedGallery');

        // Classified Icon...
        $handler->add('classified_icon', $handler::ATTACHMENT_HANDLER, 'GFNClassifieds_AttachmentHandler_ClassifiedIcon');
    }
    ...
    protected function _insertDefaultAdvertTypes()
    {
        ...
        foreach ($data as $dat)
        {
            ...
            $writer = XenForo_DataWriter::create('GFNClassifieds_DataWriter_AdvertType', XenForo_DataWriter::ERROR_SILENT);
