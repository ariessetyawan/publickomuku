 ...
 */
class GFNClassifieds_Installer_Data_1000054 extends GFNCore_Installer_Data_Abstract
{
    public function install($isUpgrade = false)
    {
        $handler = new GFNCore_Installer_Handler_ContentType('GFNClassifieds');
        $handler->add('classified', $handler::TAG_HANDLER, 'GFNClassifieds_TagHandler_Classified');
