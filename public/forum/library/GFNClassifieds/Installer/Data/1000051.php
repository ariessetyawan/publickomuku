 ...
 */
class GFNClassifieds_Installer_Data_1000051 extends GFNCore_Installer_Data_Abstract
{
    public function install($isUpgrade = false)
    {
        ...
        /*XenForo_Application::defer(
            'GFNClassifieds_Deferred_PostInstall_1000051',
            array(
                'isUpgrade' => $isUpgrade
            ), 'GFNClassifieds-1000051', true
        );*/
    ...
    protected function _insertContentTypes()
    {
        ...
        // Rating Feedback...
        $handler->add('classified_trader_rating', $handler::ALERT_HANDLER, 'GFNClassifieds_AlertHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::LIKE_HANDLER, 'GFNClassifieds_LikeHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::MODERATION_QUEUE_HANDLER, 'GFNClassifieds_ModerationQueueHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::MODERATOR_LOG_HANDLER, 'GFNClassifieds_ModeratorLogHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::NEWS_FEED_HANDLER, 'GFNClassifieds_NewsFeedHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::REPORT_HANDLER, 'GFNClassifieds_ReportHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::SPAM_HANDLER, 'GFNClassifieds_SpamHandler_TraderRating');
        $handler->add('classified_trader_rating', $handler::WARNING_HANDLER, 'GFNClassifieds_WarningHandler_TraderRating');
    }
