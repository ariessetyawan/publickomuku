 ...
 */
class KomuKuYJB_ControllerPublic_Category extends KomuKuYJB_ControllerPublic_Abstract
{
    ...
    public function actionView()
    {
        ...
        return $this->_getWrapper(
            $this->responseView(
                'KomuKuYJB_ViewPublic_Category_View',
    ...
    public function actionWatch()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Category_Watch', 'classifieds_category_watch', $viewParams);
        }
    }
    ...
    public function actionCreateItem()
    {
        ...
        return $this->responseReroute('KomuKuYJB_ControllerPublic_Classified', 'add');
    }
