 ...
 */
class KomuKuYJB_ControllerPublic_CategoryWatch extends KomuKuYJB_ControllerPublic_Abstract
{
    ...
    public function actionIndex()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_WatchedCategories', 'classifieds_watched_categories', $viewParams);
    }
    ...
    public function actionUpdate()
    {
        ...
        {
            $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_CategoryWatch');
