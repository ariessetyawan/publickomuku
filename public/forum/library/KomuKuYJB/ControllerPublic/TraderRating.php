 ...
 */
class KomuKuYJB_ControllerPublic_TraderRating extends KomuKuYJB_ControllerPublic_Abstract
{
    /**
     * @var array
     */
    ...
    public function actionView()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_View', 'classifieds_trader_rating_view', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $rating, array $viewParams = array())
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Edit', 'classifieds_trader_rating_edit', $viewParams);
    }
    ...
    public function actionLike()
    {
        ...
        if ($this->_request->isPost())
        {
            ...
            if ($this->_noRedirect() && $latestUsers !== false)
            {
                ...
                return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_LikeConfirmed', '', $viewParams);
            }
            else
            {
                return $this->responseRedirect(
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Like', 'classifieds_trader_rating_like', $viewParams);
        }
    }
    ...
    public function actionLikes()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Likes', 'classifieds_trader_rating_likes', $viewParams);
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Delete', 'classifieds_trader_rating_delete', $viewParams);
        }
    }
    ...
    public function actionShow()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Show', 'classifieds_trader_rating_feedback_list_item', $viewParams);
    }
    ...
    public function actionUndelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Undelete', 'classifieds_trader_rating_undelete', $viewParams);
        }
    }
    ...
    public function actionIp()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Ip', 'classifieds_trader_rating_ip', $viewParams);
    }
    ...
    public function actionReport()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_TraderRating_Report', 'classifieds_trader_rating_report', $viewParams);
        }
    }
