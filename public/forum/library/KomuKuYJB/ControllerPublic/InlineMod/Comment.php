 ...
 */
class KomuKuYJB_ControllerPublic_InlineMod_Comment extends KomuKuYJB_ControllerPublic_InlineMod_Abstract
{
    public $inlineModKey = 'comments';

    /**
     * @return KomuKuYJB_Model_InlineMod_Comment
     */
    public function getInlineModTypeModel()
    {
        return $this->getModelFromCache('KomuKuYJB_Model_InlineMod_Comment');
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_CommentInlineMod_Delete', 'inline_mod_classified_comment_delete', $viewParams);
        }
    }
