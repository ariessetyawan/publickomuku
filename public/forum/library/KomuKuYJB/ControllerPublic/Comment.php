 ...
 */
class KomuKuYJB_ControllerPublic_Comment extends KomuKuYJB_ControllerPublic_Abstract
{
    public function actionIndex()
    {
        ...
        return $this->responseReroute('KomuKuYJB_ControllerPublic_Classified', 'comment');
    }
    ...
    public function actionShow()
    {
        ...
        if ($comment['reply_parent_comment_id'])
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Show', 'classifieds_item_comment_reply', $viewParams);
        }
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Show', 'classifieds_item_comment_single', $viewParams);
        }
    }
    ...
    public function actionView()
    {
        ...
        if ($this->_noRedirect())
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Replies', '', $viewParams);
        }
    ...
    public function actionReply()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_Comment');
            ...
            if ($this->_noRedirect())
            {
                $reply = $this->models()->comment()->getCommentById($writer->get('comment_id'), array(
                    'join' => KomuKuYJB_Model_Comment::FETCH_USER
                ));
                ...
                return $this->responseView('KomuKuYJB_ViewPublic_Comment_Reply', '', $viewParams);
            }
            else
            {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_ReplyForm', 'classifieds_comment_reply_form', $viewParams);
        }
    }
    ...
    public function actionEdit()
    {
        ...
        return $this->responseView(
            'KomuKuYJB_ViewPublic_Comment_Edit',
    ...
    public function actionSave()
    {
        ...
        if ($this->_noRedirect())
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Insert', '', $viewParams);
        }
        else
        {
            return $this->getCommentSpecificRedirect($writer->getMergedData(), $classified, $category);
    ...
    public function actionLike()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($this->_noRedirect() && $latestUsers !== false)
            {
                ...
                return $this->responseView('KomuKuYJB_ViewPublic_Comment_LikeConfirmed', '', $viewParams);
            }
            else
            {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Like', 'classifieds_comment_like', $viewParams);
        }
    }
    ...
    public function actionLikes()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_Comment_Likes', 'classifieds_comment_likes', $viewParams);
    }
    ...
    public function actionReport()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Report', 'classifieds_comment_report', $viewParams);
        }
    }
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewPublic_Comment_Delete', 'classifieds_comment_delete', $viewParams);
        }
    }
    ...
    public function actionIp()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewPublic_Comment_Ip', 'classifieds_comment_ip', $viewParams);
    }
    ...
    public function getCommentSpecificRedirect(array $comment, array $classified, array $category, $redirectType = XenForo_ControllerResponse_Redirect::SUCCESS)
    {
        ...
        if ($comment['post_date'] < XenForo_Application::$time)
        {
            ...
            $page = floor($totalComments / KomuKuYJB_Options::getInstance()->get('commentsPerPage')) + 1;
        }
        else
        {
            $page = 1;
