 ...
 */
class KomuKuYJB_Route_Prefix_Classifieds_Fields implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        $action = $router->resolveActionWithIntegerOrStringParam($routePath, $request, 'field', 'field');
        return $router->getRouteMatch('KomuKuYJB_ControllerPublic_Classified', 'field-' . $action);
    }
