 ...
 */
class KomuKuYJB_Route_Prefix_Index implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        ...
        return $router->getRouteMatch('KomuKuYJB_ControllerPublic_Home', $action);
    }
