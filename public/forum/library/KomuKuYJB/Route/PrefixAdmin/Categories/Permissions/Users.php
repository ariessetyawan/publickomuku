 ...
 */
class KomuKuYJB_Route_PrefixAdmin_Categories_Permissions_Users implements XenForo_Route_Interface, XenForo_Route_BuilderInterface
{
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        $action = $router->resolveActionWithIntegerParam($routePath, $request, 'user_id');
        return $router->getRouteMatch('KomuKuYJB_ControllerAdmin_CategoryPermission_User', $action);
    }
