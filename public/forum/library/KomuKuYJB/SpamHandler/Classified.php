 ...
 */
class KomuKuYJB_SpamHandler_Classified extends XenForo_SpamHandler_Abstract
{
    ...
    public function cleanUp(array $user, array &$log, &$errorKey)
    {
        ...
        if ($classifieds)
        {
            ...
            /** @var KomuKuYJB_Model_InlineMod_Classified $inlineModModel */
            $inlineModModel = $this->getModelFromCache('KomuKuYJB_Model_InlineMod_Classified');
