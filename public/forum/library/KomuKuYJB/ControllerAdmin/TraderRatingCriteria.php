 ...
 */
class KomuKuYJB_ControllerAdmin_TraderRatingCriteria extends KomuKuYJB_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_RatingCriteria_List', 'classifieds_rating_criteria_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $criteria, array $viewParams = array())
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_RatingCriteria_Edit', 'classifieds_rating_criteria_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var KomuKuYJB_DataWriter_TraderRatingCriteria $writer */
        $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_TraderRatingCriteria');
    ...
    public function actionDelete()
    {
        ...
        else
        {
            ...
            return $this->responseView('KomuKuYJB_ViewAdmin_RatingCriteria_Delete', 'classifieds_rating_criteria_delete', $viewParams);
        }
    }
