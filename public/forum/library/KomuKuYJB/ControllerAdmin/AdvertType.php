 ...
 */
class KomuKuYJB_ControllerAdmin_AdvertType extends KomuKuYJB_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_AdvertType_List', 'classifieds_advert_type_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $advertType, array $viewParams = array())
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_AdvertType_Edit', 'classifieds_advert_type_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_AdvertType');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_AdvertType_Delete', 'classifieds_advert_type_delete', $viewParams);
    }
