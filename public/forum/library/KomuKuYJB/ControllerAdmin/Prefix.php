 ...
 */
class KomuKuYJB_ControllerAdmin_Prefix extends KomuKuYJB_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Prefix_List', 'classifieds_prefix_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $prefix, array $viewParams = array())
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Prefix_Edit', 'classifieds_prefix_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var KomuKuYJB_DataWriter_Prefix $writer */
        $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_Prefix');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Prefix_Delete', 'classifieds_prefix_delete', $viewParams);
    }
