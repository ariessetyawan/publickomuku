 ...
 */
class KomuKuYJB_ControllerAdmin_Package extends KomuKuYJB_ControllerAdmin_Abstract
{
    ...
    public function actionList()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Package_List', 'classifieds_package_list', $viewParams);
    }
    ...
    protected function _getAddEditResponse(array $package, array $viewParams = array())
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Package_Edit', 'classifieds_package_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        /** @var KomuKuYJB_DataWriter_Package $writer */
        $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_Package');
    ...
    public function actionDelete()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_Package_Delete', 'classifieds_package_delete', $viewParams);
    }
