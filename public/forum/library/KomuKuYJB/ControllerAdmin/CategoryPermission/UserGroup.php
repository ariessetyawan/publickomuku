 ...
 */
class KomuKuYJB_ControllerAdmin_CategoryPermission_UserGroup extends KomuKuYJB_ControllerAdmin_CategoryPermission_Abstract
{
    public function actionIndex()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_CategoryPermission_UserGroup', 'permission_classifieds_category_user_group', $viewParams);
    }
