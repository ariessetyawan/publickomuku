 ...
 */
class KomuKuYJB_ControllerAdmin_CategoryPermission_Home extends KomuKuYJB_ControllerAdmin_CategoryPermission_Abstract
{
    public function actionIndex()
    {
        ...
        return $this->responseView('KomuKuYJB_ViewAdmin_CategoryPermission_List', 'permission_classifieds_category', $viewParams);
    }
