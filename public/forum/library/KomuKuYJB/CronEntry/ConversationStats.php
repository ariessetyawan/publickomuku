 ...
 */
class KomuKuYJB_CronEntry_ConversationStats extends GFNCore_CronEntry_Abstract
{
    protected function _run()
    {
        /** @var KomuKuYJB_Model_Trader $model */
        $model = $this->_getModelFromCache('KomuKuYJB_Model_Trader');
        $db = $this->_getDb();
