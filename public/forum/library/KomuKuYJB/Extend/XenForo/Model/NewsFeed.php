 ...
 */
class KomuKuYJB_Extend_XenForo_Model_NewsFeed extends XFCP_KomuKuYJB_Extend_XenForo_Model_NewsFeed
{
    ...
    public function getNewsFeedItemsForClassified(array $conditions = array(), array $viewingUser, $maxItems = null)
    {
        ...
        return $this->fetchAllKeyed($this->limitQueryResults(
            '
				...
				WHERE ' . $whereClause . '
				AND content_type IN (' . $db->quote(KomuKuYJB_Application::$contentTypes) . ')
