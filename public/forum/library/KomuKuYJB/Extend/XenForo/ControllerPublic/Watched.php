 ...
 */
class KomuKuYJB_Extend_XenForo_ControllerPublic_Watched extends XFCP_KomuKuYJB_Extend_XenForo_ControllerPublic_Watched
{
    public function actionClassifieds()
    {
        $this->getRouteMatch()->setSections('classifieds');
        return $this->responseReroute('KomuKuYJB_ControllerPublic_ClassifiedWatch', 'index');
    }

    public function actionClassifiedCategories()
    {
        $this->getRouteMatch()->setSections('classifieds');
        return $this->responseReroute('KomuKuYJB_ControllerPublic_CategoryWatch', 'index');
    }
