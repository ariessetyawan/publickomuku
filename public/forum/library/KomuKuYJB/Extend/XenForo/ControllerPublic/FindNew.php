 ...
 */
class KomuKuYJB_Extend_XenForo_ControllerPublic_FindNew extends XFCP_KomuKuYJB_Extend_XenForo_ControllerPublic_FindNew
{
    public function actionClassifieds()
    {
        ...
        return $this->getFindNewWrapper($this->responseView(
            'KomuKuYJB_ViewPublic_FindNew_Classifieds',
    ...
    public function getNoClassifiedsResponse()
    {
        ...
        return $this->getFindNewWrapper($this->responseView(
            'KomuKuYJB_ViewPublic_FindNew_ClassifiedsNone',
