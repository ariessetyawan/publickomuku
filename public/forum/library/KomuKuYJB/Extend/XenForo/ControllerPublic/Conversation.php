 ...
 */
class KomuKuYJB_Extend_XenForo_ControllerPublic_Conversation extends XFCP_KomuKuYJB_Extend_XenForo_ControllerPublic_Conversation
{
    public function actionView()
    {
        ...
        )
        {
            ...
            if (XenForo_Application::isRegistered('KomuKuYJBContactPage'))
            {
                list ($classified, $category) = XenForo_Application::get('KomuKuYJBContactPage');
            }
            else
            {
                /** @var KomuKuYJB_ControllerHelper_Content $contentHelper */
                $contentHelper = $this->getHelper('KomuKuYJB_ControllerHelper_Content');
