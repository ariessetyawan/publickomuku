 ...
 */
class KomuKuYJB_Search_DataHandler_Classified extends XenForo_Search_DataHandler_Abstract
{
    ...
    public function getSearchFormControllerResponse(XenForo_ControllerPublic_Abstract $controller, XenForo_Input $input, array $viewParams)
    {
        ...
        /** @var KomuKuYJB_Model_Prefix $prefixModel */
        $prefixModel = XenForo_Model::create('KomuKuYJB_Model_Prefix');
        ...
        $advertTypeModel = XenForo_Model::create('KomuKuYJB_Model_AdvertType');
        ...
        return $controller->responseView('KomuKuYJB_ViewPublic_Search_Form_Classified', 'search_form_classified', $viewParams);
    }
