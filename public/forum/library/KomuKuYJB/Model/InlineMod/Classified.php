 ...
 */
class KomuKuYJB_Model_InlineMod_Classified extends XenForo_Model
{
    ...
    public function bumpClassifieds(array $classifiedIds, array $options = array(), &$errorKey = '', array $viewingUser = null)
    {
        ...
        foreach ($classifieds as $classified)
        {
            $this->_getClassifiedModel()->bumpClassified($classified,XenForo_Visitor::getUserId());
        }
    ...
    {
        return $this->getModelFromCache('KomuKuYJB_Model_Prefix');
    }
}