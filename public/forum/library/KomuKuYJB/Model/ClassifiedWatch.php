 ...
 */
class KomuKuYJB_Model_ClassifiedWatch extends KomuKuYJB_Model
{
    ...
    public function setClassifiedWatchState($userId, $classifiedId, $state)
    {
        ...
        switch ($state)
        {
            case 'watch_email':
            case 'watch_no_email':
                $writer = XenForo_DataWriter::create('KomuKuYJB_DataWriter_ClassifiedWatch', XenForo_DataWriter::ERROR_SILENT);
    ...
    public function setClassifiedWatchStateWithUserDefault($userId, $classifiedId, $state)
    {
        ...
        switch ($state)
        {
            case 'watch_email':
            case 'watch_no_email':
                $dw = XenForo_DataWriter::create('KomuKuYJB_DataWriter_ClassifiedWatch');
