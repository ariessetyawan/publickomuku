 ...
 */
class KomuKuYJB_Model_Trader extends XenForo_Model
{
    ...
    public function optedInTradersWatchClassified(array $classified)
    {
        ...
        /** @var KomuKuYJB_Model_ClassifiedWatch $model */
        $model = $this->getModelFromCache('KomuKuYJB_Model_ClassifiedWatch');
