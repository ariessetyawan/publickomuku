 ...
 */
class KomuKuYJB_DataWriter_Comment extends XenForo_DataWriter
{
    ...
    /**
     * @var KomuKuYJB_Eloquent_Classified
     */
    protected $_classified;

    /**
     * @var KomuKuYJB_Eloquent_Comment
     */
    ...
    {
        return array(
            self::OPTION_MAX_COMMENT_LENGTH => KomuKuYJB_Options::getInstance()->get('maxCommentLength'),
    ...
    protected function _postSave()
    {
        ...
        {
            KomuKuYJB_Model_NewsFeed::publish('comment', $this->getMergedData());
        }
    ...
    public function getClassified()
    {
        if (!$this->_classified)
        {
            ...
            $this->_classified = new KomuKuYJB_Eloquent_Classified($this->get('classified_id'));
        }
    ...
    public function getParentComment()
    {
        if (!$this->_parentComment)
        {
            ...
            $this->_parentComment = new KomuKuYJB_Eloquent_Comment($this->get('reply_parent_comment_id'));
        }

        return $this->_parentComment;
    }

    public function replyRemoved(KomuKuYJB_DataWriter_Comment $reply)
    {
    ...
    public function replyUpdate(KomuKuYJB_DataWriter_Comment $reply)
    {
