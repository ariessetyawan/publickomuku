<?php /*056552bf8e499USD9e6c2f162623355548898010*/
 ...
 */
class KomuKuYJB_DataWriter_Classified extends XenForo_DataWriter
{
    ...
    /**
     * @var false|KomuKuYJB_Eloquent_Payment
     */
    protected $_payment;
    ...
    protected function _getFields()
    {
        return array(
            'kmk_classifieds_classified' => array(
                ...
                'tag_line' => array(
                    'type' => self::TYPE_STRING,
                    'required' => KomuKuYJB_Options::getInstance()->get('tagLineRequired'),
                    'maxLength' => 100,
    ...
    protected function _postSave()
    {
        ...
        )
        {
            ...
            $dataHandler = XenForo_Search_DataHandler_Abstract::create('KomuKuYJB_Search_DataHandler_Classified');
        ...
        {
            KomuKuYJB_Model_NewsFeed::publish('classified', $this->getMergedData());
        }
        ...
        if ($this->_payment instanceof KomuKuYJB_Eloquent_Payment)
        {
    ...
    protected function _calculatePayment(array $package)
    {
        ...
        if ($this->isInsert())
        {
            ...
            $payment = new KomuKuYJB_Eloquent_Payment();
        ...
        if ($payment instanceof KomuKuYJB_Eloquent_Payment)
        {
    ...
    {
        return $this->getModelFromCache('KomuKuYJB_Model_Trader');
    }
    ...
    {
        return $this->getModelFromCache('KomuKuYJB_Model_AdvertType');
    }
    ...
    {
        return $this->getModelFromCache('KomuKuYJB_Model_Package');
    }

    /**
     * @var KomuKuYJB_Eloquent_Category
     */
    protected $_category;
    ...
    public function getCategory()
    {
        if (!$this->_category)
        {
            ...
            $this->_category = new KomuKuYJB_Eloquent_Category($this->get('category_id'));
        }
    ...
    /**
     * @var KomuKuYJB_Eloquent_AdvertType
     */
    ...
    public function getAdvertType()
    {
        if (!$this->_advertType)
        {
            ...
            $this->_advertType = new KomuKuYJB_Eloquent_AdvertType($this->get('advert_type_id'));
        }
    ...
    /**
     * @return false|KomuKuYJB_Eloquent_Discussion_Thread
     */
    public function getDiscussionThread()
    {
        if ($this->_discussionThread === null)
        {
            ...
            if ($this->get('discussion_thread_id'))
            {
                $thread = new KomuKuYJB_Eloquent_Discussion_Thread($this->get('discussion_thread_id'));
    ...
    /**
     * @var KomuKuYJB_DataWriter_Location
     */
    ...
    public function getLocationWriter()
    {
        if (!$this->_locationWriter)
        {
            $this->_locationWriter = XenForo_DataWriter::create('KomuKuYJB_DataWriter_Location', XenForo_DataWriter::ERROR_SILENT);
            if ($this->isUpdate())
            {
    ...
    public function commentRemoved(KomuKuYJB_DataWriter_Comment $comment)
    {
    ...
    public function commentUpdate(KomuKuYJB_DataWriter_Comment $comment)
    {
