 ...
 */
class KomuKuYJB_DataWriter_TraderRating extends XenForo_DataWriter
{
    ...
    protected function _postSave()
    {
        ...
        {
            KomuKuYJB_Model_NewsFeed::publish('trader_rating', $this->getMergedData());
        }
    ...
    {
        return $this->getModelFromCache('KomuKuYJB_Model_TraderRatingCriteria');
    }
