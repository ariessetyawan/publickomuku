 ...
 */
class KomuKuYJB_DataWriter_Category extends XenForo_DataWriter
{
    ...
    public function classifiedUpdate(KomuKuYJB_DataWriter_Classified $classified)
    {
        ...
        if ($classified->isUpdate() && $classified->isChanged('category_id'))
        {
            ...
            /** @var KomuKuYJB_DataWriter_Category $oldWriter */
            $oldWriter = XenForo_DataWriter::create('KomuKuYJB_DataWriter_Category', self::ERROR_SILENT);
    ...
    public function classifiedRemoved(KomuKuYJB_DataWriter_Classified $classified)
    {
