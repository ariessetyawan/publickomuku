 ...
 */
class KomuKu_BumpThread_Model_BumpThread extends XenForo_Model
{
	...
	public function getBumpData($userId)
	{
		...
		return $db->fetchRow("SELECT * FROM kmk_bump_thread WHERE user_id = ?", $userId);
	}
