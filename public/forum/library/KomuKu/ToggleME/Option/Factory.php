<?php
class komuku_ToggleME_Option_Factory
{
	public static function render_usergroups(XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit)
	{
		$preparedOption['formatParams'] = XenForo_Model::create('komuku_ToggleME_Model_GetUsergroups')->getUserGroupOptions($preparedOption['option_value']);
	...
	{
		$preparedOption['formatParams'] = XenForo_Model::create('komuku_ToggleME_Model_GetStyles')->getStylesOptions($preparedOption['option_value']);
		return XenForo_ViewAdmin_Helper_Option::renderOptionTemplateInternal('option_list_option_checkbox', $view, $fieldPrefix, $preparedOption, $canEdit);
	}

	public static function render_nodes(XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit)
	{
		$preparedOption['formatParams'] = XenForo_Model::create('komuku_ToggleME_Model_GetNodes')->getNodesOptions($preparedOption['option_value']);
		return XenForo_ViewAdmin_Helper_Option::renderOptionTemplateInternal('option_list_option_checkbox', $view, $fieldPrefix, $preparedOption, $canEdit);
	}
		...
		$configs = XenForo_Model::create('komuku_ToggleME_Model_GetNodes')->manageLanguageNodesOptions($optionValue);
      		...
      		return $view->createTemplateObject('option_toggleme_language_categories', array(
      			...
      			'editLink' => $editLink,
      			'configs' => $configs,
      			'nodes' => XenForo_Model::create('komuku_ToggleME_Model_GetNodes')->getNodesOptions(),
