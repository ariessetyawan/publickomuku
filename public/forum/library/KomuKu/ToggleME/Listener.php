<?php
class komuku_ToggleME_Listener
{
	...
	public static function template_hook($hookName, &$contents, array $hookParams, XenForo_Template_Abstract $template)
	{
		switch ($hookName) 
		{
			case 'forum_list_nodes':
				...
				/*Custom Language*/
				$langCheck = komuku_ToggleME_Helper_CustomLanguage::isEnabled();
				if($langCheck)
				{
					$userBrowserLanguage = self::getClientPreferedLanguage();
					$languageCategories = komuku_ToggleME_Helper_CustomLanguage::getLanguageConfig();
					...
					$langCloseAllCategories = komuku_ToggleME_Helper_CustomLanguage::closeAllCategories();
	...
	public static function getClientPreferedLanguage()
	{
		...
		{
			$clientPreferedLanguage = strtolower(komuku_ToggleME_Helper_Misc::getClientPreferedLanguage(!komuku_ToggleME_Helper_CustomLanguage::useFullLanguageCode()));
