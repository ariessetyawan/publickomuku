...
class KomuKu_featuredmembers_WidgetRenderer_FeaturedMembers extends WidgetFramework_WidgetRenderer
{
    public function extraPrepareTitle(array $widget)
    {
        if (empty($widget['title'])) {
            return new XenForo_Phrase('dad_fm_fm');
        }
    ...
    protected function _render(
        ...
        $userIds = $wfUserModel->getUserIds(array('dad_fm_is_featured' => true), array(
