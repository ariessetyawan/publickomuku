...
class KomuKu_SimilarThreads_ControllerPublic_Forum extends XFCP_KomuKu_SimilarThreads_ControllerPublic_Forum
{
    ...
    public function actionSimilarThreads()
    {
		...
		$similarThreads = $this->getModelFromCache('KomuKu_SimilarThreads_Model')->getThreads($searchWord1,$searchWord2,$searchWord3,$currentNodeId,$currentThreadId);  
		...
		// send to template
		return $this->responseView('KomuKu_SimilarThreads_ViewPublic_SimilarThreads', 'KomuKu_similarthreads_create_thread', $viewParams);	
	}
}