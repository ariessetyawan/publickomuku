...
abstract class KomuKu_SimilarThreads_Option_NodeChooser
{
	public static function renderSelect(XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit)
	{
		return self::_render('KomuKu_option_list_option_select_similar_threads', $view, $fieldPrefix, $preparedOption, $canEdit);
	}
