...
class KomuKu_Listener_ControllerPreDispatch
{
	...
	protected function _checkAddOnsNeedUpgrading(array $addOns, $checkDisabled = false)
	{
		...
		eval(
			'
			class KomuKu_Listener_ControllerPreDispatch_TemplatePostRender
			{
				public static function templatePostRender($templateName, &$content, array &$containerData, XenForo_Template_Abstract $template)
				{
					if ($templateName == "PAGE_CONTAINER") {
						$upgradeAddOns = KomuKu_Listener_ControllerPreDispatch::getUpgradeAddOns();
		...
		$newListener = array(
			'KomuKu_Listener_ControllerPreDispatch_TemplatePostRender',
			'templatePostRender'
		);
		if (XenForo_Application::$versionId < 1020000) {
	 ...
	 * @param string $controllerName since XenForo 1.2
	 *
	 * @return KomuKu_Listener_ControllerPreDispatch
	 */
