...
abstract class KomuKu_SimpleForms_Destination_Abstract
{
	protected $_formId;
	protected $_fields;
	protected $_options;
			...
			if ($field['active'])
			{
						...
						|| $field['field_type'] == 'rating')
				{
					...
					else
					{
						...
						{
							$templateFields[$field['field_name']]['value'] = $field['field_value'] . (new XenForo_Phrase('kmkform__rating_separator')) . XenForo_Application::getOptions()->kmkform_RatingMax;
						}
						else
						{
