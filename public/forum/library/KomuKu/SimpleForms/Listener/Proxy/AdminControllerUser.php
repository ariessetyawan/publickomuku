...
class KomuKu_SimpleForms_Listener_Proxy_AdminControllerUser extends XFCP_KomuKu_SimpleForms_Listener_Proxy_AdminControllerUser
{
	/**
	...
	public function actionSearchUsername()
	{
		...
		return $this->responseView(
			'KomuKu_SimpleForms_ViewAdmin_User_SearchUsername',
			'',
			$viewParams
		);
	}	
