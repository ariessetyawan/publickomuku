...
class KomuKu_SimpleForms_AttachmentHandler_Form extends XenForo_AttachmentHandler_Abstract
{
	...
	protected function _getFormModel()
	{
		if (!$this->_formModel)
		{
			$this->_formModel = XenForo_Model::create('KomuKu_SimpleForms_Model_Form');
		}
