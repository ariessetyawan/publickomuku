...
class KomuKu_SimpleForms_Model_Response extends XenForo_Model
{
	/**
	...
	public function getResponseById($id)
	{
		...
		return $this->_getDb()->fetchRow('
			...
			FROM kmkform__response AS response
	...
	public function prepareResponseJoinOptions(array $fetchOptions)
	{
		...
		if (isset($fetchOptions['username']) && $fetchOptions['username'])
		{
			...
			$joinTables .= "LEFT JOIN kmk_user AS user ON (user.user_id = response.user_id)";
		}
