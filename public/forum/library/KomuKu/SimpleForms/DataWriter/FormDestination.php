...
class KomuKu_SimpleForms_DataWriter_FormDestination extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmkform__form_destination'		=> array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmkform__form_destination' => $this->_getFormModel()->getFormDestinationById($id));
	}
	...
	*/
	...
	protected function _preDelete()
	{
		...
		$db->delete('kmkform__form_destination_option', "form_destination_id = $formDestinationIdQuoted");
