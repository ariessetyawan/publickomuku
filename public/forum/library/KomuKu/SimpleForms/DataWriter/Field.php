...
class KomuKu_SimpleForms_DataWriter_Field extends XenForo_DataWriter
{
	/**
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmkform__field' => $this->_getFieldModel()->getFieldById($id));
	}
	...
	*/
	...
	protected function _preDelete()
	{
		...
		if ($this->get('type') == 'global')
		{
			$fieldModel = new KomuKu_SimpleForms_Model_Field();
				...
				case 'delete':
					{
						foreach ($associatedFields as $associatedFieldId => $associatedField)
						{
							...
							$db->delete('kmkform__response_field', "field_id = $quotedFieldId");
						
							// delete the field
							$db->delete('kmkform__field', "field_id = $quotedFieldId");
						}						
					}	
					break;
				...
				case 'convert':
					{
						foreach ($associatedFields as $associatedFieldId => $associatedField)
						{
							$dw = new KomuKu_SimpleForms_DataWriter_Field();
		...
		$db->delete('kmkform__response_field', "field_id = $fieldIdQuoted");
