...
class KomuKu_SimpleForms_DataWriter_Form extends XenForo_DataWriter
{
	/**
	...
	/**
	 * Returns all kmk_node fields, plus form-specific fields
	 */
	...
	*/
	...
	protected function _preDelete()
	{
		...
		$db->delete('kmkform__response_field', "field_id IN (SELECT field_id FROM kmkform__field WHERE form_id = $formIdQuoted)");
		$db->delete('kmkform__response', "form_id = $formIdQuoted");
		$db->delete('kmkform__form_destination_option', "form_destination_id IN (SELECT form_destination_id FROM kmkform__form_destination WHERE form_id = $formIdQuoted)");
		$db->delete('kmkform__form_destination', "form_id = $formIdQuoted");
		$db->delete('kmkform__field', "form_id = $formIdQuoted");
	...
	*/
	...
	{
		return $this->getModelFromCache('KomuKu_SimpleForms_Model_Form');
	}
	
	/**
	 * @return KomuKu_SimpleForms_Model_DestinationOption
	 */
	protected function _getDestinationOptionModel()
	{
		return $this->getModelFromCache('KomuKu_SimpleForms_Model_DestinationOption');
	}
	
	/**
	 * @return KomuKu_SimpleForms_Model_Destination
	 */
	protected function _getDestinationModel()
	{
		return $this->getModelFromCache('KomuKu_SimpleForms_Model_Destination');
	}
	
	/**
	 * @return KomuKu_SimpleForms_DataWriter_Page
	 */
	protected function _getPageDataWriter()
	{
	    return XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Page');
	}
	...
	{
	    return $this->getModelFromCache('KomuKu_SimpleForms_Model_Page');
	}
}