...
class KomuKu_SimpleForms_DataWriter_Destination extends XenForo_DataWriter
{
	/**
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmkform__destination' => $this->_getDestinationModel()->getDestinationById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmkform__form_destination_option', 'option_id IN (SELECT option_id FROM kmkform__destination_option WHERE destination_id = ' . $this->_db->quote($destinationId) . ')');
		$this->_db->delete('kmkform__destination_option', 'destination_id = ' . $this->_db->quote($destinationId));
	}	
