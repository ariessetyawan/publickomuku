...
class KomuKu_SimpleForms_ControllerAdmin_Form extends KomuKu_SimpleForms_ControllerAdmin_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_dataWriterName = 'KomuKu_SimpleForms_DataWriter_Form';
	...
	{		
		...
		if (XenForo_Application::getOptions()->kmkform_SortOrder == 'custom')
		{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_List', 'kmkform__form_list', $viewParams);
	}
	...
	public function actionAdd()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Add', 'kmkform__form_add', $viewParams);
	}
	...
	public function actionEdit()
	{
		...
		{
			return $this->responseReroute('KomuKu_SimpleForms_ControllerAdmin_Form', 'add');
		}
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Edit', 'kmkform__form_edit', $viewParams);
	}
	...
	public function actionResponses()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Responses', 'kmkform__form_responses', $viewParams);
	}
	...
	public function actionValidateField()
	{
		...
		{
			$writer = XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Form');
			if ($existingKey)
			{
		...
		else
		{
			...
			return $this->_validateField(
				'KomuKu_SimpleForms_DataWriter_Form',
	...
	public function actionExportResponses()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_ExportResponses', '', $viewParams);
	}
	...
	public function actionExport()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Export', '', $viewParams);
	}
	...
	public function actionSave()
	{
		...
		{
			return $this->responseReroute('KomuKu_SimpleForms_ControllerAdmin_Form', 'deleteConfirm');
		}
	...
	public function actionDelete()
	{
		...
		if ($this->isConfirmedPost())
		{
			return $this->_deleteData(
				'KomuKu_SimpleForms_DataWriter_Form', 'form_id',
		...
		else
		{
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Delete', 'kmkform__form_delete', $viewParams);
		}
	}	
	...
	public function actionImport()
	{
		...
		{
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Import', 'kmkform__form_import');
		}
	}	
	...
	{ 
		...
		if ($this->isConfirmedPost())
		{
			...
			$dw->setExtraData(KomuKu_SimpleForms_DataWriter_Field::DATA_TITLE, $global['field_name']);
			$dw->setExtraData(KomuKu_SimpleForms_DataWriter_Field::DATA_DESCRIPTION, '');
		...
		else
		{
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_AddGlobalField', 'kmkform__form_add_global_field', $viewParams);
		}
	}	
	...
	public function actionDocumentation()
	{
	    return $this->responseRedirect(
	        ...
	        'https://KomuKu.atlassian.net/wiki/display/SF/Wiki'
        );
	}
	
	/**
	 * @return KomuKu_SimpleForms_DataWriter_Form
	 */
	...
	/**
	 * @return KomuKu_SimpleForms_DataWriter_FormDestination
	 */
	protected function _getFormDestinationDataWriter()
	{
		return XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_FormDestination');
	}
	...
	{
		$dw = XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Form');
	...
	{
	    KomuKu_SimpleForms_Option_LicenseKey::resetLocalKey();
