...
class KomuKu_SimpleForms_ControllerAdmin_Destination extends KomuKu_SimpleForms_ControllerAdmin_Abstract
{
	public function actionIndex()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Destination_List', 'kmkform__destination_list', $viewParams);
	}
	...
	protected function _getFieldAddEditResponse(array $destination)
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Destination_Edit', 'kmkform__destination_edit', $viewParams);
	}
	...
	public function actionSave()
	{
		...
		$writer = XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Destination');
		if ($destinationId)
		{
		...
		$writer->setExtraData(
			KomuKu_SimpleForms_DataWriter_Destination::DATA_NAME,
	...
	public function actionDelete()
	{
		...
		if ($this->isConfirmedPost())
		{
			return $this->_deleteData(
				'KomuKu_SimpleForms_DataWriter_Destination', 'destination_id',
		...
		else
		{
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Destination_Delete', 'kmkform__destination_delete', $viewParams);
		}
	}	
}