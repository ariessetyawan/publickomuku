...
class KomuKu_SimpleForms_ControllerAdmin_Response extends KomuKu_SimpleForms_ControllerAdmin_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_dataWriterName = 'KomuKu_SimpleForms_DataWriter_Response';
	...
	public function actionEdit()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Response_Edit', 'kmkform__response_edit', $viewParams);
	}	
	...
	public function actionDelete()
	{
		...
		if ($this->isConfirmedPost())
		{
			return $this->_deleteData(
				'KomuKu_SimpleForms_DataWriter_Response', 'response_id',
		...
		else
		{
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Response_Delete', 'kmkform__response_delete', $viewParams);
		}
	}	
	...
	public function actionClear()
	{
		...
		if ($this->isConfirmedPost())
		{
			...
			return $this->responseRedirect(XenForo_ControllerResponse_Redirect::SUCCESS, 
				XenForo_Link::buildAdminLink('forms/responses', $form),
				new XenForo_Phrase('kmkform__responses_cleared')
			);
		}
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Form_Clear', 'kmkform__response_clear', $viewParams);
	}
}