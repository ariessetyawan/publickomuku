...
class KomuKu_SimpleForms_ControllerAdmin_FormDestination extends KomuKu_SimpleForms_ControllerAdmin_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_dataWriterName = 'KomuKu_SimpleForms_DataWriter_FormDestination';
	...
	protected function _getFormDestinationAddEditResponse(array $formDestination)
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_FormDestination_Edit', 'kmkform__form_destination_edit', $viewParams);
	}	
	...
	public function actionDelete()
	{
		...
		if ($this->isConfirmedPost())
		{
			return $this->_deleteData(
				'KomuKu_SimpleForms_DataWriter_FormDestination', 'form_destination_id',
				XenForo_Link::buildAdminLink('forms/edit', '', array('form_id' => $formId)) . '#destinations'
			);
		}
		else
		{
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_FormDestination_Delete', 'kmkform__form_destination_delete', $viewParams);
		}
	}	
	...
	{
		$dw = XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_FormDestination');
	...
	{
		return XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Form');
	}	
}