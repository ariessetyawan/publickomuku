...
class KomuKu_SimpleForms_ControllerAdmin_Field extends KomuKu_SimpleForms_ControllerAdmin_Abstract
{
	/**
	...
	protected function _getFieldAddEditResponse(array $field)
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Field_Edit', 'kmkform__field_edit', $viewParams);
	}
	...
	public function actionTemplates()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Field_TemplatesList', 'kmkform__field_templates_list', $viewParams);
	}
	...
	public function actionGlobals()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Field_GlobalsList', 'kmkform__field_globals_list', $viewParams);
	}	
	...
	public function actionSave()
	{
		...
		// set the title and description
		$dw->setExtraData(KomuKu_SimpleForms_DataWriter_Field::DATA_TITLE, $title);
		$dw->setExtraData(KomuKu_SimpleForms_DataWriter_Field::DATA_DESCRIPTION, $description);
	...
	public function actionDelete()
	{
		...
		if ($this->isConfirmedPost())
		{
			...
			return $this->_deleteData('KomuKu_SimpleForms_DataWriter_Field', 'field_id', $redirect);
		}
		else
		{
			$field = $this->_getFieldOrError($this->_input->filterSingle('field_id', XenForo_Input::STRING));
			...
			return $this->responseView('KomuKu_SimpleForms_ViewAdmin_Field_Delete', 'kmkform__field_delete', $viewParams);
		}
	}
