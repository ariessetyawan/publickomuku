...
class KomuKu_SimpleForms_Route_Prefix_Forms implements XenForo_Route_Interface
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('KomuKu_SimpleForms_ControllerPublic_Form', $action, 'forms');
	}
