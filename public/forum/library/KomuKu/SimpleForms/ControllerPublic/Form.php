...
class KomuKu_SimpleForms_ControllerPublic_Form extends XenForo_ControllerPublic_Abstract
{
	public function actionIndex()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewPublic_Form_List', 'form_list', $viewParams);
	}
	...
	public function actionRespond()
	{
		...
		return $this->responseView('KomuKu_SimpleForms_ViewPublic_Form_Respond', 'form_respond', $viewParams);
	}
	...
	public function actionSave()
	{
		...
		/* @var $writer KomuKu_SimpleForms_DataWriter_Response */
		$writer = XenForo_DataWriter::create('KomuKu_SimpleForms_DataWriter_Response');
		$writerData = array(
			'form_id' => $formId,
		...
		if ($attachmentHash)
		{
			$writer->setExtraData(KomuKu_SimpleForms_DataWriter_Response::DATA_ATTACHMENT_HASH, $this->_input->filterSingle('attachment_hash', XenForo_Input::STRING));
		}
	...
	public function actionSearchTitle()
	{
		...
		return $this->responseView(
			'KomuKu_SimpleForms_ViewPublic_Form_SearchTitle',
			'',
			$viewParams
		);
	}	
	...
	public static function getSessionActivityDetailsForList(array $activities)
	{
		...
		foreach ($activities AS $key => $activity)
		{
			...
			{
				$output[$key] = array(
					new XenForo_Phrase('kmkform__viewing_form'),
					$form['title'],
					$form['url'],
					''
				);
			...
			{
				$output[$key] = new XenForo_Phrase('kmkform__viewing_form');
			}
		}
	...
	/**
	 * @return KomuKu_SimpleForms_Model_Field
	 */
	protected function _getFieldModel()
	{
		return $this->getModelFromCache('KomuKu_SimpleForms_Model_Field');
	}	
