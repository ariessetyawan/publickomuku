...
class KomuKu_FAQ_Listener_TemplateHook
{
    /**
     * navTabs function.
     *
    ...
    public static function navTabs(array &$extraTabs, $selected)
    {
        ...
        if (isset($tabPosition['type']) and $tabPosition['type'] != 'default') {
            ...
            $faqCatModel = XenForo_Model::create('KomuKu_FAQ_Model_Category');
