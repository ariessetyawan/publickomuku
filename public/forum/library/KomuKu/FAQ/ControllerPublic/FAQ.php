...
class KomuKu_FAQ_ControllerPublic_FAQ extends XenForo_ControllerPublic_Abstract
{
    ...
    public function actionIndex()
    {
        ...
        $indexTemplate = 'KomuKu_faq_index';

        if ($faqIndexLayout == 'jump_links') {
            $indexTemplate = 'KomuKu_faq_jump_links';
            ...
            $indexTemplate = 'KomuKu_faq_question_columns';
            $questions = $questionModel->getAll([
                'order'     => XenForo_Application::get('options')->faqSortOrder,
                'direction' => XenForo_Application::get('options')->faqSortOrderDir,
            ]);
        ...
        return $this->getWrapper(
            'faq',
            'index',
            $this->responseView('KomuKu_FAQ_ViewPublic_Index', $indexTemplate, $viewParams)
        );
    }
    ...
    public function actionAsk()
    {
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_Ask', 'KomuKu_faq_ask', $viewParams);
    }
    ...
    public function actionAskSave()
    {
        ...
        $dw = XenForo_DataWriter::create('KomuKu_FAQ_DataWriter_Question');
        $dw->bulkSet(
            [
        ...
        return $this->responseRedirect(
            ...
            new XenForo_Phrase('KomuKu_faq_question_added')
        );
    }
    ...
    public function actionCategory()
    {
        ...
        return $this->getWrapper('category', $category_id, $this->responseView('KomuKu_FAQ_ViewPublic_Index', 'KomuKu_faq_category', $viewParams));
    }
    ...
    public function actionCategoryCreate()
    {
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_Category', 'KomuKu_faq_create_category', []);
    }
    ...
    public function actionCategoryEdit()
    {
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_Category', 'KomuKu_faq_edit_category', $viewParams);
    }
    ...
    public function actionCategorySave()
    {
        ...
        $category_id = $this->_input->filterSingle('faq_id', XenForo_Input::UINT);
        $saveAction = new XenForo_Phrase('KomuKu_faq_category_added');

        $dw = XenForo_DataWriter::create('KomuKu_FAQ_DataWriter_Category');
        if ($category_id) {
            $dw->setExistingData($category_id);
            $saveAction = new XenForo_Phrase('KomuKu_faq_category_edited');
        }
        $dw->bulkSet(
            [
    ...
    public function actionCategoryDelete()
    {
        ...
        return $this->responseRedirect(
            XenForo_ControllerResponse_Redirect::SUCCESS,
            XenForo_Link::buildPublicLink('faq'),
            new XenForo_Phrase('KomuKu_faq_category_deleted')
        );
    }
    ...
    public function actionPermalink()
    {
        ...
        $question['like_date'] = $likeModel->getContentLikeByLikeUser('kmk_faq_question', $faq_id, $user_id);
        ...
        return $this->getWrapper('faq', 'x', $this->responseView('KomuKu_FAQ_ViewPublic_Permalink', 'KomuKu_faq_question', $viewParams));
    }
    ...
    public function actionLike()
    {
        ...
        $existingLike = $likeModel->getContentLikeByLikeUser('kmk_faq_question', $faq_id, XenForo_Visitor::getUserId());

        if ($this->_request->isPost()) {
            if ($existingLike) {
                $latestUsers = $likeModel->unlikeContent($existingLike);
            } else {
                $latestUsers = $likeModel->likeContent('kmk_faq_question', $faq_id, $question['user_id']);
            }
            ...
            if ($this->_noRedirect() && $latestUsers !== false) {
                ...
                return $this->responseView('KomuKu_FAQ_ViewPublic_LikeConfirmed', '', $viewParams);
            } else {
                return $this->responseRedirect(
                    XenForo_ControllerResponse_Redirect::SUCCESS,
                    XenForo_Link::buildPublicLink('faq', $question)
            ...
            return $this->responseView('KomuKu_FAQ_ViewPublic_Like', 'KomuKu_faq_question_like', $viewParams);
        }
    }
    ...
    public function actionLikes()
    {
        ...
        $likes = $this->getModelFromCache('XenForo_Model_Like')->getContentLikes('kmk_faq_question', $faq_id);
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_PageLikes', 'KomuKu_faq_question_all_likes', $viewParams);
    }
    ...
    public function actionCreate()
    {
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_Create', 'KomuKu_faq_create', $viewParams);
    }
    ...
    public function actionEdit()
    {
        ...
        $attachments = $attachmentModel->getAttachmentsByContentId('kmk_faq_question', $question['faq_id']);
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_Edit', 'KomuKu_faq_edit', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        if ($faq_id) {
            ...
            $dw->setExtraData(KomuKu_FAQ_DataWriter_Question::DATA_ATTACHMENT_HASH, $input['attachment_hash']);
            $dw->save();

            $returnLink = XenForo_Link::buildPublicLink('full:faq', ['faq_id' => $faq_id, 'question' => $input['question']]);
            $saveAction = new XenForo_Phrase('KomuKu_faq_question_edited');
        } else {
            // New question
            $dw = XenForo_DataWriter::create('KomuKu_FAQ_DataWriter_Question');
            $dw->bulkSet(
            ...
            $saveAction = new XenForo_Phrase('KomuKu_faq_question_added');
        }
    ...
    public function actionDelete()
    {
        ...
        return $this->responseRedirect(
            XenForo_ControllerResponse_Redirect::SUCCESS,
            XenForo_Link::buildPublicLink('faq'),
            new XenForo_Phrase('KomuKu_faq_question_deleted')
        );
    }
    ...
    public function actionLatestAnswers()
    {
        ...
        return $this->responseView('KomuKu_FAQ_ViewPublic_LatestAnswers', '', $viewParams);
    }
    ...
    public static function getSessionActivityDetailsForList(array $activities)
    {
        foreach ($activities as $key => $activity) {
            ...
            $faqLinkText = new XenForo_Phrase('KomuKu_faq');
            ...
            if (!empty($activity['params']['faq_id'])) {
                ...
                if (isset($question)) {
                    $faqLinkText = new XenForo_Phrase('KomuKu_faq').' #'.$faq_id.': '.$question;
    ...
    {
        $faqHelper = new KomuKu_FAQ_ControllerHelper_FAQ($this);
    ...
    {
        return $this->getModelFromCache('KomuKu_FAQ_Model_Question');
    }

    protected function _getCategoryModel()
    {
        return $this->getModelFromCache('KomuKu_FAQ_Model_Category');
    }
