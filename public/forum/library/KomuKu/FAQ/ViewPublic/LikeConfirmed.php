...
class KomuKu_FAQ_ViewPublic_LikeConfirmed extends XenForo_ViewPublic_Base
{
    public function renderJson()
    {
        ...
        if (!empty($question['like_users'])) {
            ...
            $output = $this->_renderer->getDefaultOutputArray(get_class($this), $params, 'KomuKu_faq_question_likes_summary');
        } else {
