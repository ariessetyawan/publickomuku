...
class KomuKu_FAQ_LikeHandler_Question extends XenForo_LikeHandler_Abstract
{
    public function incrementLikeCounter($contentId, array $latestLikes, $adjustAmount = 1)
    {
        $writer = XenForo_DataWriter::create('KomuKu_FAQ_DataWriter_Question');
    ...
    {
        $questionModel = XenForo_Model::create('KomuKu_FAQ_Model_Question');
    ...
    public function getListTemplateName()
    {
        ...
        return 'news_feed_item_kmk_faq_question_like';
    }
}
