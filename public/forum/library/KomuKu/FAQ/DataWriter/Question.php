...
class KomuKu_FAQ_DataWriter_Question extends XenForo_DataWriter
{
    ...
    protected function _getFields()
    {
        return [
            'kmk_faq_question'    => [
                ...
                'category_id'   => ['type' => self::TYPE_UINT, 'default' => ['kmk_faq_category', 'category_id'], 'required' => true],
    ...
    protected function _getExistingData($data)
    {
        ...
        return ['kmk_faq_question' => $this->getModelFromCache('KomuKu_FAQ_Model_Question')->getById($id)];
    }
    ...
    {
        $rows = $this->_db->update('kmk_attachment', [
        ...
        if ($rows) {
            ...
            $this->_db->update('kmk_faq_question', [
    ...
    {
        // Gets the search-data handler for 'kmk_faq_question' content type
