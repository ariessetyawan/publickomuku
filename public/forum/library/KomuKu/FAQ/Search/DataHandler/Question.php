...
class KomuKu_FAQ_Search_DataHandler_Question extends XenForo_Search_DataHandler_Abstract
{
    ...
    protected function _deleteFromIndex(XenForo_Search_Indexer $indexer, array $dataList)
    {
        ...
        $indexer->deleteFromIndex('kmk_faq_question', $ids);
    }
    ...
    {
        $indexer->updateIndex('kmk_faq_question', $data['faq_id'], $fieldUpdates);
    }
    ...
    {
        return $controller->responseView('KomuKu_FAQ_ViewPublic_Search_Form_Question', 'search_form_question', $viewParams);
    }
    ...
    {
        return $view->createTemplateObject('kmk_faq_question_search_result', [
            'question'  => $result,
            'search'    => $search,
        ]);
    }
    ...
    private function getQuestionModel()
    {
        if (!$this->questionModel) {
            $this->questionModel = XenForo_Model::create('KomuKu_FAQ_Model_Question');
        }
