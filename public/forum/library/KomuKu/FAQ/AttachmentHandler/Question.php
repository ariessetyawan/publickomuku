...
class KomuKu_FAQ_AttachmentHandler_Question extends XenForo_AttachmentHandler_Abstract
{
    protected $_contentIdKey = 'faq_id';
    protected $_contentRoute = 'faq';
    protected $_contentTypePhraseKey = 'kmk_faq_question';
