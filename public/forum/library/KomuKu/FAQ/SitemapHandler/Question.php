...
class KomuKu_FAQ_SitemapHandler_Question extends XenForo_SitemapHandler_Abstract
{
    protected $_questionModel;

    public function getPhraseKey($key)
    {
        return 'KomuKu_faq_questions';
    }
    ...
    protected function _questionModel()
    {
        if (!$this->_questionModel) {
            $this->_questionModel = XenForo_Model::create('KomuKu_FAQ_Model_Question');
        }
