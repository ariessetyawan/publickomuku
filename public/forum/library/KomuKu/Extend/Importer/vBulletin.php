<?php
define('KomuKu_Extend_Importer_vBulletin_LOADED', true);
class KomuKu_Extend_Importer_vBulletin extends XFCP_KomuKu_Extend_Importer_vBulletin {
	...
	public function stepReputation($start, array $options) {
		...
		foreach ($reputations AS $rep) {
			...
			if ($receivedUserId > 0 && $givenUserId > 0 && $postId > 0) {
				$dw = XenForo_DataWriter::create('KomuKu_DataWriter_Given', XenForo_DataWriter::ERROR_ARRAY);
