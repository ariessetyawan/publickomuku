 ...
 */
class KomuKuJVC_Route_PrefixAdmin_Directory implements XenForo_Route_Interface
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('KomuKuJVC_ControllerAdmin_Directory', $action, 'nodeTree');
	}
