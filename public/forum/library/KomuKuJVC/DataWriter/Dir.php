<?php
/**
* Data writer for Dir (clone of Forums).
*
* @package XenForo_Forum
*/
//class KomuKuJVC_DataWriter_Dir extends XenForo_DataWriter_Node implements XenForo_DataWriter_DiscussionContainerInterface
class KomuKuJVC_DataWriter_Dir extends KomuKuJVC_DataWriter_DirectoryNode implements XenForo_DataWriter_DiscussionContainerInterface
{
	/**
	...
	/**
	 * Returns all kmk_node fields, plus forum-specific fields
	 */
	protected function _getFields()
	{
		
		
		return parent::_getFields() + array('kmk_jobvacan_dir' => array(

			'node_id'            => array('type' => self::TYPE_UINT, 'default' => array('kmk_jobvacan_directory_node', 'node_id'), 'required' => true),
	...
	*/
	protected function _getExistingData($data)
	{
		...
		$forum = $this->getModelFromCache('KomuKuJVC_Model_Dir')->getForumById($nodeId);
		if (!$forum)
		{
			return false;
		}
