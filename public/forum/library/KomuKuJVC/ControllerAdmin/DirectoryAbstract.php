...
abstract class KomuKuJVC_ControllerAdmin_DirectoryAbstract extends XenForo_ControllerAdmin_Abstract
{
	 ...
	 */
	 ...
	 // delete confirm seems to be working, unless there are child nodes
...
// */			
	...
	/**
	 * @return KomuKuJVC_Model_Directory
	 */
	...
	/**
	 * @return XenForo_Model_Style (we can just use the XenForoStyle)
	 */
