...
class XenForo_Model_Moderator extends XenForo_Model
{
	...
	public function getGeneralModeratorByUserId($userId)
	{
		return $this->_getDb()->fetchRow('
			...
			FROM kmk_moderator AS moderator
			INNER JOIN kmk_user AS user ON (user.user_id = moderator.user_id)
	...
	public function getContentModerators(array $conditions = array(), array $fetchOptions = array())
	{
		...
		return $this->fetchAllKeyed($this->limitQueryResults(
			'
				...
				FROM kmk_moderator_content AS moderator_content
				INNER JOIN kmk_user AS user ON (user.user_id = moderator_content.user_id)
	...
	{
		return $this->_getDb()->fetchOne('SELECT COUNT(*) FROM kmk_moderator');
	}
