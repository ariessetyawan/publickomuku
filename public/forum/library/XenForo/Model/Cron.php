...
class XenForo_Model_Cron extends XenForo_Model
{
	...
	public function getAllCronEntries()
	{
		return $this->fetchAllKeyed('
			...
			FROM kmk_cron_entry AS entry
			LEFT JOIN kmk_addon AS addon ON (entry.addon_id = addon.addon_id)
	...
	{
		$db = $this->_getDb();
		$db->delete('kmk_cron_entry', 'addon_id = ' . $db->quote($addOnId));
	}
