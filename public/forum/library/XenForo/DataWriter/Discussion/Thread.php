...
class XenForo_DataWriter_Discussion_Thread extends XenForo_DataWriter_Discussion
{
	...
	*/
	protected function _getFields()
	{
		...
		$fields['kmk_thread']['first_post_likes'] = array('type' => self::TYPE_UINT_FORCED, 'default' => 0);
		$fields['kmk_thread']['prefix_id'] = array('type' => self::TYPE_UINT, 'default' => 0);
	...
	*/
	...
	protected function _discussionPostDelete()
	{
		...
		$this->_db->delete('kmk_thread_watch', "thread_id = $threadIdQuoted");
		$this->_db->delete('kmk_thread_user_post', "thread_id = $threadIdQuoted");
		$this->_db->delete('kmk_thread_reply_ban', "thread_id = $threadIdQuoted");
