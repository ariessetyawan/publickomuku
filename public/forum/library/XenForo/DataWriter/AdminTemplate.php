...
class XenForo_DataWriter_AdminTemplate extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_admin_template' => $this->getModelFromCache('XenForo_Model_AdminTemplate')->getAdminTemplateById($templateId));
	}
	...
	*/
	protected function _postSave()
	{
		...
		{
			$this->_db->delete('kmk_admin_template_compiled', 'title = ' . $this->_db->quote($this->getExisting('title')));
			$this->_db->delete('kmk_admin_template_include', 'source_id = ' . $this->_db->quote($this->get('template_id')));
			$this->_db->delete('kmk_admin_template_phrase', 'template_id = ' . $this->_db->quote($this->get('template_id')));
		}
	...
	*/
	...
	{
		$this->_db->delete('kmk_admin_template_compiled', 'title = ' . $this->_db->quote($this->get('title')));
		$this->_db->delete('kmk_admin_template_include', 'source_id = ' . $this->_db->quote($this->get('template_id')));
		$this->_db->delete('kmk_admin_template_phrase', 'template_id = ' . $this->_db->quote($this->get('template_id')));
		$this->_db->delete('kmk_admin_template_modification_log', 'template_id = ' . $this->_db->quote($this->get('template_id')));
