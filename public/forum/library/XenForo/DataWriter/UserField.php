...
class XenForo_DataWriter_UserField extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_user_field' => $this->_getFieldModel()->getUserFieldById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_user_field_value', 'field_id = ' . $this->_db->quote($fieldId));
		// note the user caches aren't rebuilt here; this shouldn't be an issue as we don't enumerate them

		$this->_db->delete('kmk_user_change_log', 'field = ' . $this->_db->quote("custom_fields:$fieldId"));
