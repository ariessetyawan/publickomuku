...
class XenForo_DataWriter_Poll extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_poll' => $this->_getPollModel()->getPollById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_poll_response', 'poll_id = ' . $pollIdQuoted);
		$this->_db->delete('kmk_poll_vote', 'poll_id = ' . $pollIdQuoted);

		if ($this->get('content_type') == 'thread')
		{
			$this->_db->update('kmk_thread',
