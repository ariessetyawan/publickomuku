...
class XenForo_DataWriter_Template extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_template' => $this->_getTemplateModel()->getTemplateById($template_id));
	}
	...
	*/
	protected function _postSave()
	{
		...
		{
			$this->_db->insert('kmk_template_history', array(
	...
	*/
	...
	{
		$this->_db->delete('kmk_template_modification_log',
	...
	protected function _deleteMappedData()
	{
		...
		if ($mappedTemplates)
		{
			...
			if ($parentMappedTemplate)
			{
				...
				$this->_db->update('kmk_template_map',
			...
			else
			{
				...
				$this->_db->delete('kmk_template_map', 'template_map_id IN (' . $templateMapIdsQuoted . ')');
				$this->_db->delete('kmk_template_phrase', 'template_map_id IN (' . $templateMapIdsQuoted . ')');
				$this->_db->delete('kmk_template_include', 'source_map_id IN (' . $templateMapIdsQuoted . ')');
				$this->_db->delete('kmk_template_compiled',
