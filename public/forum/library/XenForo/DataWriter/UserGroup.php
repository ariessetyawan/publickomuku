...
class XenForo_DataWriter_UserGroup extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_user_group' => $this->_getUserGroupModel()->getUserGroupById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_permission_entry', 'user_group_id = ' . $this->_db->quote($userGroupId));
		$this->_db->delete('kmk_permission_entry_content', 'user_group_id = ' . $this->_db->quote($userGroupId));
