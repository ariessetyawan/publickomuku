...
class XenForo_DataWriter_AddOn extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_addon' => $this->_getAddOnModel()->getAddOnById($id));
	}
	...
	*/
	...
	protected function _postSave()
	{
		if ($this->isUpdate() && $this->isChanged('addon_id'))
		{
			...
			$db->update('kmk_admin_navigation', $updateValue, $updateClause);
			$db->update('kmk_admin_permission', $updateValue, $updateClause);
			$db->update('kmk_admin_template', $updateValue, $updateClause);
			$db->update('kmk_admin_template_modification', $updateValue, $updateClause);
			$db->update('kmk_bb_code_media_site', $updateValue, $updateClause);
			$db->update('kmk_code_event', $updateValue, $updateClause);
			$db->update('kmk_code_event_listener', $updateValue, $updateClause);
			$db->update('kmk_content_type', $updateValue, $updateClause);
			$db->update('kmk_cron_entry', $updateValue, $updateClause);
			$db->update('kmk_email_template', $updateValue, $updateClause);
			$db->update('kmk_email_template_modification', $updateValue, $updateClause);
			$db->update('kmk_option', $updateValue, $updateClause);
			$db->update('kmk_option_group', $updateValue, $updateClause);
			$db->update('kmk_permission', $updateValue, $updateClause);
			$db->update('kmk_permission_group', $updateValue, $updateClause);
			$db->update('kmk_permission_interface_group', $updateValue, $updateClause);
			$db->update('kmk_phrase', $updateValue, $updateClause);
			$db->update('kmk_route_prefix', $updateValue, $updateClause);
			$db->update('kmk_style_property_definition', $updateValue, $updateClause);
			$db->update('kmk_style_property_group', $updateValue, $updateClause);
			$db->update('kmk_template', $updateValue, $updateClause);
			$db->update('kmk_template_modification', $updateValue, $updateClause);
		}
