...
class XenForo_DataWriter_ProfilePostComment extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmk_profile_post_comment' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_profile_post_comment' => $this->_getProfilePostModel()->getProfilePostCommentById($id));
	}
	...
	*/
	protected function _updateIpData()
	{
		...
		$this->_db->update('kmk_profile_post_comment',
			array('ip_id' => $ipId),
