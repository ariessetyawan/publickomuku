...
class XenForo_DataWriter_Permission extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_permission' => $this->_getPermissionModel()->getPermissionByGroupAndId($groupId, $permissionId));
	}
	...
	*/
	...
	protected function _renamePermissionEntries()
	{
		...
		$this->_db->update('kmk_permission_entry', $updateFields, $condition);
		$this->_db->update('kmk_permission_entry_content', $updateFields, $condition);
	}
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_permission_entry', $condition);
		$this->_db->delete('kmk_permission_entry_content', $condition);
