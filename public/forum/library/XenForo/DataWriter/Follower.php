...
class XenForo_DataWriter_Follower extends XenForo_DataWriter
{
	...
	/**
	 * Returns all kmk_user_follow fields
	 *
	 * @see library/XenForo/DataWriter/XenForo_DataWriter#_getFields()
	 */
	protected function _getFields()
	{
		return array('kmk_user_follow' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_user_follow' => $this->_getUserModel()->getFollowRecord($userId, $followUserId));
	}
