...
class XenForo_DataWriter_UserGroupPromotion extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmk_user_group_promotion' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_user_group_promotion' => $this->_getPromotionModel()->getPromotionById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_user_group_promotion_log',
