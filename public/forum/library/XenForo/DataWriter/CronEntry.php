...
class XenForo_DataWriter_CronEntry extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_cron_entry' => $this->_getCronModel()->getCronEntryById($id));
	}
	...
	*/
	...
	protected function _verifyRunRules(&$runRules)
	{
		...
		{
			$runRulesNew = XenForo_Helper_Php::safeUnserialize($runRulesNew);
			if (!is_array($runRulesNew))
			{
				$runRulesNew = array();
			}
		...
		$runRules = XenForo_Helper_Php::safeSerialize($runRulesNew);
