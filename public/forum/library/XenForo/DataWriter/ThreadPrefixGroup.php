...
class XenForo_DataWriter_ThreadPrefixGroup extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_thread_prefix_group' => $this->_getPrefixModel()->getPrefixGroupById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$this->_db->update('kmk_thread_prefix', array('prefix_group_id' => 0), 'prefix_group_id = ' . $this->_db->quote($prefixGroupId));
