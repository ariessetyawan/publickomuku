...
class XenForo_DataWriter_Page extends XenForo_DataWriter_Node
{
	...
	/**
	 * Returns all kmk_node fields, plus page-specific fields
	 *
	 * @see library/XenForo/DataWriter/XenForo_DataWriter_Node#_getFields()
	 */
	protected function _getFields()
	{
		$fields = parent::_getFields() + array('kmk_page' => array(
			'node_id' =>
				array('type' => self::TYPE_UINT, 'default' => array('kmk_node', 'node_id'), 'required' => true),
			'publish_date' =>
		...
		$fields['kmk_node']['node_name']['required'] = true;
		$fields['kmk_node']['node_name']['requiredError'] = 'please_enter_valid_url_portion';
