...
class XenForo_DataWriter_PermissionInterfaceGroup extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmk_permission_interface_group' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_permission_interface_group' => $this->_getPermissionModel()->getPermissionInterfaceGroupById($id));
	}
	...
	*/
	...
	protected function _postSave()
	{
		if ($this->isUpdate() && $this->isChanged('interface_group_id'))
		{
			...
			$this->_db->update('kmk_permission',
