...
class XenForo_DataWriter_StylePropertyGroup extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmk_style_property_group' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array(
			'kmk_style_property_group' => $this->_getStylePropertyModel()->getStylePropertyGroupById($groupId)
		);
	}
	...
	*/
	...
	protected function _postSave()
	{
		...
		if ($this->getOption(self::OPTION_UPDATE_MASTER_PHRASE))
		{
			...
			if ($this->isUpdate() && $this->isChanged('group_name'))
			{
				$this->_getStylePropertyModel()->moveStylePropertiesBetweenGroups(
					$this->getExisting('group_name'), $this->getNew('group_name'), $this->getExisting('group_style_id')
				);
			}
		}
