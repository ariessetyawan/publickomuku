...
{
	/**
	 * Returns all kmk_feed fields
	 *
	 * @see XenForo_DataWriter::_getFields()
	 */
	protected function _getFields()
	{
		return array('kmk_feed' => array(
			'feed_id'
	...
	protected function _getExistingData($data)
	{
		...
		return array('kmk_feed' => $this->_getFeedModel()->getFeedById($id));
	}
	...
	{
		$this->_db->delete('kmk_feed_log', 'feed_id = ' . $this->_db->quote($this->get('feed_id')));
	}
