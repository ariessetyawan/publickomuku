...
{
	protected $_modTableName = 'kmk_email_template_modification';
	protected $_logTableName = 'kmk_email_template_modification_log';

	protected function _getFields()
	{
		$fields = parent::_getFields();
		$fields['kmk_email_template_modification']['search_location'] = array(
