...
class XenForo_DataWriter_ConversationMessage extends XenForo_DataWriter
{
	...
	*/
	...
	{
		return array(
			'kmk_conversation_message' => array(
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_conversation_message' => $this->_getConversationModel()->getConversationMessageById($id));
	}
	...
	*/
	...
	{
		$rows = $this->_db->update('kmk_attachment', array(
		...
		if ($rows)
		{
			...
			$this->_db->update('kmk_conversation_message', array(
	...
	*/
	protected function _updateIpData()
	{
		...
		$this->_db->update('kmk_conversation_message',
			array('ip_id' => $ipId),
			'message_id = ' .  $this->_db->quote($this->get('message_id'))
		);
	}
