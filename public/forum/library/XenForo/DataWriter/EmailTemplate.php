...
class XenForo_DataWriter_EmailTemplate extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_email_template' => $this->_getEmailTemplateModel()->getEmailTemplateById($templateId));
	}
	...
	*/
	...
	{
		$this->_db->delete('kmk_email_template_modification_log', 'template_id = ' . $this->_db->quote($this->get('template_id')));
		...
		else
		{
			...
			$this->_db->delete('kmk_email_template', 'title = ' . $titleQuoted);
			$this->_db->delete('kmk_email_template_compiled', 'title = ' . $titleQuoted);
			$this->_db->delete('kmk_email_template_phrase', 'title = ' . $titleQuoted);
		}
