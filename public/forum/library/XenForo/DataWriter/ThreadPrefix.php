...
class XenForo_DataWriter_ThreadPrefix extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_thread_prefix' => $this->_getPrefixModel()->getPrefixById($id));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$db = $this->_db;
		$db->update('kmk_forum', array('default_prefix_id' => 0), 'default_prefix_id = ' . $db->quote($prefixId));
		$db->update('kmk_thread', array('prefix_id' => 0), 'prefix_id = ' . $db->quote($prefixId));
