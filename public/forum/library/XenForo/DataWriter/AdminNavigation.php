...
class XenForo_DataWriter_AdminNavigation extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_admin_navigation' => $this->_getAdminNavigationModel()->getAdminNavigationEntryById($id));
	}
	...
	*/
	...
	protected function _postSave()
	{
		if ($this->isUpdate() && $this->isChanged('navigation_id'))
		{
			...
			$this->_db->update('kmk_admin_navigation',
