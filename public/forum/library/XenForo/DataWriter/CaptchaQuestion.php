...
class XenForo_DataWriter_CaptchaQuestion extends XenForo_DataWriter
{
	...
	/**
	 * Returns all kmk_captcha_question fields
	 *
	 * @see XenForo_DataWriter::_getFields()
	 */
	protected function _getFields()
	{
		return array('kmk_captcha_question' => array(
			'captcha_question_id'
	...
	protected function _getExistingData($data)
	{
		...
		return array('kmk_captcha_question' => $this->_getCaptchaQuestionModel()->getCaptchaQuestionById($id));
	}
