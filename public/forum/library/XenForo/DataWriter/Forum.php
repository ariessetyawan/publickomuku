...
class XenForo_DataWriter_Forum extends XenForo_DataWriter_Node implements XenForo_DataWriter_DiscussionContainerInterface
{
	...
	{
		return parent::_getFields() + array('kmk_forum' => array(

			'node_id'            => array('type' => self::TYPE_UINT, 'default' => array('kmk_node', 'node_id'), 'required' => true),
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$db->delete('kmk_forum_watch', 'node_id = ' . $db->quote($nodeId));
