...
class XenForo_DataWriter_Language extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_language' => $this->_getLanguageModel()->getLanguageById($languageId));
	}
	...
	*/
	...
	protected function _postDelete()
	{
		...
		$db->delete('kmk_phrase', 'language_id = ' . $db->quote($languageId));
		$db->delete('kmk_phrase_map', 'language_id = ' . $db->quote($languageId));
		$db->delete('kmk_phrase_compiled', 'language_id = ' . $db->quote($languageId));
		$db->delete('kmk_template_compiled', 'language_id = ' . $db->quote($languageId));
		if (XenForo_Application::get('options')->templateFiles)
		{
			XenForo_Template_FileHandler::delete(null, null, $languageId);
		}
		$db->delete('kmk_admin_template_compiled', 'language_id = ' . $db->quote($languageId));
		$db->delete('kmk_email_template_compiled', 'language_id = ' . $db->quote($languageId));
