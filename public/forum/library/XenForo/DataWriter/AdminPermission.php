...
class XenForo_DataWriter_AdminPermission extends XenForo_DataWriter
{
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('kmk_admin_permission' => $this->_getAdminModel()->getAdminPermissionById($id));
	}
	...
	*/
	...
	protected function _postSave()
	{
		...
		if ($this->isChanged('admin_permission_id') && $this->isUpdate())
		{
			...
			$db = $this->_db;
			$db->update('kmk_admin_permission_entry', array(
	...
	protected function _postDelete()
	{
		...
		$this->_db->delete('kmk_admin_permission_entry',
