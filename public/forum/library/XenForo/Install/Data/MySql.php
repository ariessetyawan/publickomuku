...
$tables['kmk_admin_log'] = "
	CREATE TABLE kmk_admin_log (
...
$tables['kmk_admin_navigation'] = "
	CREATE TABLE kmk_admin_navigation (
...
$tables['kmk_admin_permission'] = "
	CREATE TABLE kmk_admin_permission (
...
$tables['kmk_admin_permission_entry'] = "
	CREATE TABLE kmk_admin_permission_entry (
...
$tables['kmk_admin_search_type'] = "
	CREATE TABLE kmk_admin_search_type (
...
$tables['kmk_admin_template'] = "
	CREATE TABLE kmk_admin_template (
...
$tables['kmk_admin_template_compiled'] = "
	CREATE TABLE kmk_admin_template_compiled (
...
$tables['kmk_admin_template_include'] = "
	CREATE TABLE kmk_admin_template_include (
...
$tables['kmk_admin_template_modification'] = "
	CREATE TABLE `kmk_admin_template_modification` (
...
$tables['kmk_admin_template_modification_log'] = "
	CREATE TABLE `kmk_admin_template_modification_log` (
...
$tables['kmk_admin_template_phrase'] = "
	CREATE TABLE kmk_admin_template_phrase (
...
$tables['kmk_attachment'] = "
	CREATE TABLE kmk_attachment (
...
$tables['kmk_attachment_data'] = "
	CREATE TABLE kmk_attachment_data (
...
$tables['kmk_attachment_view'] = "
	CREATE TABLE kmk_attachment_view (
...
$tables['kmk_ban_email'] = "
	CREATE TABLE kmk_ban_email (
...
$tables['kmk_bb_code_media_site'] = "
	CREATE TABLE kmk_bb_code_media_site (
...
$tables['kmk_bb_code_parse_cache'] = "
	CREATE TABLE kmk_bb_code_parse_cache (
...
$tables['kmk_code_event'] = "
	CREATE TABLE kmk_code_event (
...
$tables['kmk_code_event_listener'] = "
	CREATE TABLE kmk_code_event_listener (
...
$tables['kmk_content_spam_cache'] = "
	CREATE TABLE `kmk_content_spam_cache` (
...
$tables['kmk_content_type'] = "
	CREATE TABLE kmk_content_type (
		content_type VARBINARY(25) NOT NULL,
		addon_id VARBINARY(25) NOT NULL DEFAULT '',
...
$tables['kmk_content_type_field'] = "
	CREATE TABLE kmk_content_type_field (
		content_type VARBINARY(25) NOT NULL,
...
$tables['kmk_conversation_master'] = "
	CREATE TABLE kmk_conversation_master (
...
$tables['kmk_conversation_message'] = "
	CREATE TABLE kmk_conversation_message (
...
$tables['kmk_conversation_recipient'] = "
	CREATE TABLE kmk_conversation_recipient (
		conversation_id INT UNSIGNED NOT NULL,
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_conversation_user'] = "
	CREATE TABLE kmk_conversation_user (
		conversation_id INT UNSIGNED NOT NULL,
...
$tables['kmk_cron_entry'] = "
	CREATE TABLE kmk_cron_entry (
...
$tables['kmk_data_registry'] = "
	CREATE TABLE kmk_data_registry (
...
$tables['kmk_deletion_log'] = "
	CREATE TABLE kmk_deletion_log (
		content_type VARBINARY(25) NOT NULL,
...
$tables['kmk_edit_history'] = "
	CREATE TABLE kmk_edit_history (
...
$tables['kmk_email_bounce_log'] = "
	CREATE TABLE kmk_email_bounce_log (
...
$tables['kmk_email_bounce_soft'] = "
	CREATE TABLE kmk_email_bounce_soft (
...
$tables['kmk_email_template'] = "
	CREATE TABLE kmk_email_template (
...
$tables['kmk_email_template_compiled'] = "
	CREATE TABLE kmk_email_template_compiled (
		language_id INT UNSIGNED NOT NULL,
		title VARBINARY(50) NOT NULL,
...
$tables['kmk_email_template_modification'] = "
	CREATE TABLE `kmk_email_template_modification` (
		`modification_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`addon_id` VARBINARY(25) NOT NULL,
		`template` VARBINARY(50) NOT NULL,
		`modification_key` VARBINARY(50) NOT NULL,
...
$tables['kmk_email_template_modification_log'] = "
	CREATE TABLE `kmk_email_template_modification_log` (
		`template_id` int(10) unsigned NOT NULL,
		`modification_id` int(10) unsigned NOT NULL,
		`status` varchar(25) NOT NULL,
		`apply_count` int(10) unsigned NOT NULL DEFAULT '0',
...
$tables['kmk_email_template_phrase'] = "
	CREATE TABLE kmk_email_template_phrase (
		title VARBINARY(50) NOT NULL,
		phrase_title VARBINARY(100) NOT NULL,
...
$tables['kmk_error_log'] = "
	CREATE TABLE kmk_error_log (
...
$tables['kmk_flood_check'] = "
	CREATE TABLE kmk_flood_check (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_forum'] = "
	CREATE TABLE kmk_forum (
		...
		prefix_cache MEDIUMBLOB NOT NULL COMMENT 'Serialized data from kmk_forum_prefix, [group_id][prefix_id] => prefix_id',
...
$tables['kmk_forum_prefix'] = "
	CREATE TABLE kmk_forum_prefix (
		node_id INT UNSIGNED NOT NULL,
...
$tables['kmk_forum_read'] = "
	CREATE TABLE kmk_forum_read (
...
$tables['kmk_forum_watch'] = "
	CREATE TABLE kmk_forum_watch (
		`user_id` int(10) unsigned NOT NULL,
...
$tables['kmk_help_page'] = "
	CREATE TABLE kmk_help_page (
...
$tables['kmk_image_proxy'] = "
	CREATE TABLE `kmk_image_proxy` (
...
$tables['kmk_image_proxy_referrer'] = "
	CREATE TABLE `kmk_image_proxy_referrer` (
...
$tables['kmk_import_log'] = "
	CREATE TABLE kmk_import_log (
		content_type VARBINARY(25) NOT NULL,
...
$tables['kmk_liked_content'] = "
	CREATE TABLE kmk_liked_content (
...
$tables['kmk_link_proxy'] = "
	CREATE TABLE `kmk_link_proxy` (
...
$tables['kmk_link_proxy_referrer'] = "
	CREATE TABLE `kmk_link_proxy_referrer` (
		`referrer_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$tables['kmk_link_forum'] = "
	CREATE TABLE kmk_link_forum (
		node_id INT UNSIGNED NOT NULL,
...
$tables['kmk_login_attempt'] = "
	CREATE TABLE kmk_login_attempt (
...
$tables['kmk_mail_queue'] = "
	CREATE TABLE `kmk_mail_queue` (
...
$tables['kmk_moderation_queue'] = "
	CREATE TABLE kmk_moderation_queue (
		content_type VARBINARY(25) NOT NULL,
		content_id INT UNSIGNED NOT NULL,
...
$tables['kmk_moderator'] = "
	CREATE TABLE kmk_moderator (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_moderator_content'] = "
	CREATE TABLE kmk_moderator_content (
...
$tables['kmk_moderator_log'] = "
	CREATE TABLE kmk_moderator_log (
...
$tables['kmk_news_feed'] = "
	CREATE TABLE kmk_news_feed (
...
$tables['kmk_node_type'] = "
	CREATE TABLE kmk_node_type (
		node_type_id VARBINARY(25) NOT NULL,
		handler_class VARCHAR(75) NOT NULL,
...
$tables['kmk_notice_dismissed'] = "
	CREATE TABLE kmk_notice_dismissed (
...
$tables['kmk_option_group'] = "
	CREATE TABLE kmk_option_group (
...
$tables['kmk_option_group_relation'] = "
	CREATE TABLE kmk_option_group_relation (
		option_id VARBINARY(50) NOT NULL,
		group_id VARBINARY(50) NOT NULL,
		display_order INT UNSIGNED NOT NULL,
...
$tables['kmk_permission'] = "
	CREATE TABLE kmk_permission (
...
$tables['kmk_permission_cache_content'] = "
	CREATE TABLE kmk_permission_cache_content (
...
$tables['kmk_permission_combination'] = "
	CREATE TABLE kmk_permission_combination (
...
$tables['kmk_permission_combination_user_group'] = "
	CREATE TABLE kmk_permission_combination_user_group (
...
$tables['kmk_permission_entry'] = "
	CREATE TABLE kmk_permission_entry (
...
$tables['kmk_permission_entry_content'] = "
	CREATE TABLE kmk_permission_entry_content (
		permission_entry_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
		content_type VARBINARY(25) NOT NULL,
		content_id INT UNSIGNED NOT NULL,
		user_group_id INT UNSIGNED NOT NULL,
...
$tables['kmk_permission_group'] = "
	CREATE TABLE kmk_permission_group (
		permission_group_id VARBINARY(25) NOT NULL,
		addon_id VARBINARY(25) NOT NULL DEFAULT '',
...
$tables['kmk_permission_interface_group'] = "
	CREATE TABLE kmk_permission_interface_group (
		interface_group_id VARBINARY(50) NOT NULL,
		display_order INT UNSIGNED NOT NULL,
		addon_id VARBINARY(25) NOT NULL DEFAULT '',
...
$tables['kmk_phrase_compiled'] = "
	CREATE TABLE kmk_phrase_compiled (
		language_id INT UNSIGNED NOT NULL,
		title VARBINARY(100) NOT NULL,
		phrase_text MEDIUMTEXT NOT NULL,
		PRIMARY KEY (language_id, title)
...
$tables['kmk_phrase_map'] = "
	CREATE TABLE kmk_phrase_map (
...
$tables['kmk_poll_response'] = "
	CREATE TABLE kmk_poll_response (
...
$tables['kmk_poll_vote'] = "
	CREATE TABLE kmk_poll_vote (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_profile_post'] = "
	CREATE TABLE kmk_profile_post (
...
$tables['kmk_profile_post_comment'] = "
	CREATE TABLE kmk_profile_post_comment (
...
$tables['kmk_registration_spam_cache'] = "
	CREATE TABLE kmk_registration_spam_cache (
...
$tables['kmk_report_comment'] = "
	CREATE TABLE kmk_report_comment (
...
$tables['kmk_route_filter'] = "
	CREATE TABLE `kmk_route_filter` (
...
$tables['kmk_route_prefix'] = "
	CREATE TABLE kmk_route_prefix (
...
$tables['kmk_search_index'] = "
	CREATE TABLE kmk_search_index (
...
$tables['kmk_session_activity'] = "
	CREATE TABLE kmk_session_activity (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_session_admin'] = "
	CREATE TABLE kmk_session_admin (
		session_id VARBINARY(32) NOT NULL,
		session_data MEDIUMBLOB NOT NULL,
		expiry_date INT UNSIGNED NOT NULL,
		PRIMARY KEY (session_id),
...
$tables['kmk_smilie_category'] = "
	CREATE TABLE kmk_smilie_category (
...
$tables['kmk_spam_cleaner_log'] = "
	CREATE TABLE kmk_spam_cleaner_log (
...
$tables['kmk_spam_trigger_log'] = "
	CREATE TABLE `kmk_spam_trigger_log` (
...
$tables['kmk_stats_daily'] = "
	CREATE TABLE kmk_stats_daily (
...
$tables['kmk_style_property'] = "
	CREATE TABLE kmk_style_property (
...
$tables['kmk_style_property_definition'] = "
	CREATE TABLE kmk_style_property_definition (
...
$tables['kmk_style_property_group'] = "
	CREATE TABLE kmk_style_property_group (
...
$tables['kmk_tag_content'] = "
	CREATE TABLE kmk_tag_content (
...
$tables['kmk_tag_result_cache'] = "
	CREATE TABLE kmk_tag_result_cache (
...
$tables['kmk_template_compiled'] = "
	CREATE TABLE kmk_template_compiled (
		style_id INT UNSIGNED NOT NULL,
		language_id INT UNSIGNED NOT NULL,
		title VARBINARY(50) NOT NULL,
		template_compiled MEDIUMBLOB NOT NULL COMMENT 'Executable PHP code built by template compiler',
...
$tables['kmk_template_history'] = "
	CREATE TABLE kmk_template_history (
...
$tables['kmk_template_include'] = "
	CREATE TABLE kmk_template_include (
...
$tables['kmk_template_map'] = "
	CREATE TABLE kmk_template_map (
...
$tables['kmk_template_modification'] = "
	CREATE TABLE `kmk_template_modification` (
		`modification_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`addon_id` VARBINARY(25) NOT NULL,
		`template` VARBINARY(50) NOT NULL,
		`modification_key` VARBINARY(50) NOT NULL,
...
$tables['kmk_template_modification_log'] = "
	CREATE TABLE `kmk_template_modification_log` (
		`template_id` int(10) unsigned NOT NULL,
		`modification_id` int(10) unsigned NOT NULL,
		`status` varchar(25) NOT NULL,
		`apply_count` int(10) unsigned NOT NULL DEFAULT '0',
...
$tables['kmk_template_phrase'] = "
	CREATE TABLE kmk_template_phrase (
...
$tables['kmk_tfa_attempt'] = "
	CREATE TABLE kmk_tfa_attempt (
...
$tables['kmk_tfa_provider'] = "
	CREATE TABLE kmk_tfa_provider (
...
$tables['kmk_thread_prefix'] = "
	CREATE TABLE kmk_thread_prefix (
...
$tables['kmk_thread_prefix_group'] = "
	CREATE TABLE kmk_thread_prefix_group (
...
$tables['kmk_thread_read'] = "
	CREATE TABLE kmk_thread_read (
...
$tables['kmk_thread_redirect'] = "
	CREATE TABLE kmk_thread_redirect (
		thread_id INT UNSIGNED NOT NULL,
...
$tables['kmk_thread_reply_ban'] = "
	CREATE TABLE kmk_thread_reply_ban (
...
$tables['kmk_thread_user_post'] = "
	CREATE TABLE kmk_thread_user_post (
		thread_id INT UNSIGNED NOT NULL,
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_thread_view'] = "
	CREATE TABLE kmk_thread_view (
		thread_id INT UNSIGNED NOT NULL,
		KEY thread_id (thread_id)
	) ENGINE=MEMORY CHARACTER SET utf8 COLLATE utf8_general_ci
";

$tables['kmk_thread_watch'] = "
	CREATE TABLE kmk_thread_watch (
		user_id INT UNSIGNED NOT NULL,
		thread_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_title_ladder'] = "
	CREATE TABLE kmk_user_title_ladder (
...
$tables['kmk_upgrade_log'] = "
	CREATE TABLE kmk_upgrade_log (
...
$tables['kmk_user_alert'] = "
	CREATE TABLE kmk_user_alert (
...
$tables['kmk_user_alert_optout'] = "
	CREATE TABLE kmk_user_alert_optout (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_authenticate'] = "
	CREATE TABLE kmk_user_authenticate (
...
$tables['kmk_user_change_log'] = "
	CREATE TABLE `kmk_user_change_log` (
...
$tables['kmk_user_change_temp'] = "
	CREATE TABLE kmk_user_change_temp (
...
$tables['kmk_user_confirmation'] = "
	CREATE TABLE kmk_user_confirmation (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_external_auth'] = "
	CREATE TABLE kmk_user_external_auth (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_field'] = "
	CREATE TABLE kmk_user_field (
...
$tables['kmk_user_field_value'] = "
	CREATE TABLE kmk_user_field_value (
		user_id INT UNSIGNED NOT NULL,
		field_id VARBINARY(25) NOT NULL,
...
$tables['kmk_user_follow'] = "
	CREATE TABLE kmk_user_follow (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_group'] = "
	CREATE TABLE kmk_user_group (
...
$tables['kmk_user_group_change'] = "
	CREATE TABLE kmk_user_group_change (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_group_promotion'] = "
	CREATE TABLE kmk_user_group_promotion (
...
$tables['kmk_user_group_promotion_log'] = "
	CREATE TABLE kmk_user_group_promotion_log (
...
$tables['kmk_user_group_relation'] = "
	CREATE TABLE kmk_user_group_relation (
		user_id INT UNSIGNED NOT NULL,
		user_group_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_ignored'] = "
	CREATE TABLE kmk_user_ignored (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_news_feed_cache'] = "
	CREATE TABLE kmk_user_news_feed_cache (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_option'] = "
	CREATE TABLE kmk_user_option (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_privacy'] = "
	CREATE TABLE kmk_user_privacy (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_profile'] = "
	CREATE TABLE kmk_user_profile (
		user_id INT UNSIGNED NOT NULL,
		...
		dob_year SMALLINT UNSIGNED NOT NULL DEFAULT '0',
 		...
 		following TEXT NOT NULL COMMENT 'Comma-separated integers from kmk_user_follow',
 		ignored TEXT NOT NULL COMMENT 'Comma-separated integers from kmk_user_ignored',
...
$tables['kmk_user_status'] = "
	CREATE TABLE kmk_user_status (
		profile_post_id INT UNSIGNED NOT NULL,
		user_id INT UNSIGNED NOT NULL,
		post_date INT UNSIGNED NOT NULL,
...
$tables['kmk_user_tfa_trusted'] = "
	CREATE TABLE kmk_user_tfa_trusted (
...
$tables['kmk_user_trophy'] = "
	CREATE TABLE kmk_user_trophy (
		user_id INT UNSIGNED NOT NULL,
...
$tables['kmk_user_upgrade'] = "
	CREATE TABLE kmk_user_upgrade (
...
$tables['kmk_user_upgrade_active'] = "
	CREATE TABLE kmk_user_upgrade_active (
...
$tables['kmk_user_upgrade_expired'] = "
	CREATE TABLE kmk_user_upgrade_expired (
...
$tables['kmk_user_upgrade_log'] = "
	CREATE TABLE kmk_user_upgrade_log (
...
$tables['kmk_warning_action'] = "
	CREATE TABLE kmk_warning_action (
...
$tables['kmk_warning_action_trigger'] = "
	CREATE TABLE kmk_warning_action_trigger (
...
$tables['kmk_warning_definition'] = "
	CREATE TABLE kmk_warning_definition (
...
$data['kmk_tfa_provider'] = "
	INSERT INTO `kmk_tfa_provider`
...
$data['kmk_warning_definition'] = "
	INSERT INTO kmk_warning_definition
...
$data['kmk_permission_combination'] = "
	INSERT INTO kmk_permission_combination
...
$data['kmk_permission_combination_user_group'] = "
	INSERT INTO kmk_permission_combination_user_group
...
$data['kmk_permission_entry'] = "
	INSERT INTO kmk_permission_entry
...
$data['kmk_bb_code_media_site'] = '
	INSERT INTO kmk_bb_code_media_site
...
$data['kmk_user_title_ladder'] = "
	INSERT INTO kmk_user_title_ladder
		(minimum_level, title)
	VALUES
		(0, 'New Member'),
		(5, 'Member'),
...
$data['kmk_admin_search_type'] = "
	INSERT INTO kmk_admin_search_type
