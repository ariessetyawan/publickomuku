	...
	*/
	...
	public function getDefaultTables($tables = array())
	{
		if($this->_triggerType != 'uninstall'){
			$tables['kmk_brivium_addon'] = "
				CREATE TABLE IF NOT EXISTS `kmk_brivium_addon` (
			...
			";
			$tables['kmk_brivium_listener_class'] = "
				CREATE TABLE IF NOT EXISTS `kmk_brivium_listener_class` (
