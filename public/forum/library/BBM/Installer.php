...
class BBM_Installer
{
	...
	public static function install($addon)
	{
		...
		if(empty($addon))
		{
			...
			self::addColumnIfNotExist($db, 'kmk_forum', 'bbm_bm_editor', "varchar(25) NOT NULL DEFAULT 'disable'");
		}
	...
	public static function uninstall()
	{
		...
		if ($db->fetchRow('SHOW COLUMNS FROM kmk_forum WHERE Field = ?', 'bbm_bm_editor'))
		{
			$db->query("ALTER TABLE kmk_forum DROP bbm_bm_editor");
		}
